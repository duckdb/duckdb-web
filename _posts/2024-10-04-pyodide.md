...
```html
<iframe src="https://alex-monahan.github.io/jupyterlite_duckdb_demo/lab/index.html?path=hello_duckdb.ipynb" style="height: 60vw; width: 100%;"></iframe>
```
...
4. Visit `https://YOUR_GITHUB_USERNAME.github.io/YOUR_REPOSITORY-NAME/lab/index.html?path=my_notebook.ipynb`

Note that it can take a couple of minutes for GitHub Pages to deploy. 
You can monitor the progress on GitHub's Actions tab.

> Note If you want to revert to the original file, just right click and delete the file. 

### JupyterLite Notebook

After following the steps in the JupterLite Lab IDE setup, if you change your URL from `/lab/` to `/notebook/`, you can have a Notebook environment instead!
This form factor is a little easier to embed in another site.
...
```html
<iframe src="https://alex-monahan.github.io/jupyterlite_duckdb_demo/notebooks/index.html?path=magic_duckdb.ipynb" style="height: 60vw; width: 100%;"></iframe>
```
