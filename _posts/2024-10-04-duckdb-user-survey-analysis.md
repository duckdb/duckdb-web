...
[Unsurprisingly](https://www.tiobe.com/tiobe-index/python/), DuckDB is most often used from Python (73%), followed by the [standalone command-line application]({% link docs/current/clients/cli/overview.md %}) (47%).
...
**ease of use**,
**extensive SQL support** (including [friendly SQL]({% link docs/current/sql/dialect/friendly_sql.md %}))
