...
extensions may choose to only depend on highly mature, stable libraries with good portability, whereas others may choose
...
SELECT column_a, column_b FROM “az://my-container/some-file.parquet”;
```
