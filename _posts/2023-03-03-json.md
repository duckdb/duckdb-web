...
DuckDB has a [JSON extension]({% link docs/data/json/overview.md %}) that can be installed and loaded through SQL:
...
This function is similar to our `read_csv` function, which [automatically infers column names and types for CSV files]({% link docs/data/csv/auto_detection.md %}).
