...
layout: post  
title:  "Practical SQL for Data Analysis - What you can do with Pandas and DuckDB"
author: Mark Raasveldt and Hannes Mühleisen
excerpt_separator: <!--more-->

---

<!--#### DuckDB is a fully in-process embedded OLAP database system that is completely free and open source (MIT licensed).

# Practical SQL for Data Analysis
### What you can do with Pandas and DuckDB
-->
...
```py
lineitem.agg(Sum=('l_extendedprice', 'sum'), Min=('l_extendedprice', 'min'), Max=('l_extendedprice', 'max'), Avg=('l_extendedprice', 'mean'))
```
...
```py
lineitem.groupby(['l_returnflag', 'l_linestatus']).agg(Sum=('l_extendedprice', 'sum'), Min=('l_extendedprice', 'min'), Max=('l_extendedprice', 'max'), Avg=('l_extendedprice', 'mean')
```
...
result = filtered_df.groupby(['l_returnflag', 'l_linestatus']).agg(Sum=('l_extendedprice', 'sum'), Min=('l_extendedprice', 'min'), Max=('l_extendedprice', 'max'), Avg=('l_extendedprice', 'mean'))
```
