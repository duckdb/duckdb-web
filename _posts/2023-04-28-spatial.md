...
You can find the datasets used in this example in the [spatial extension repository](https://github.com/duckdblabs/duckdb_spatial/tree/main/test/data/nyc_taxi).
