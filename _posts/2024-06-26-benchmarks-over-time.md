...
The code used to run the benchmark also avoids many of DuckDB's [Friendlier SQL]({% link docs/lts/sql/dialect/friendly_sql.md %}) additions, as those have also been added more recently.
...
The DuckDB documentation contains a [full railroad diagram of the available syntax]({% link docs/lts/sql/functions/window_functions.md %}#syntax).
