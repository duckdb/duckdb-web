...
> The DuckDB UI is the result of a [collaboration]({% link faq.md %}#how-are-duckdb-the-duckdb-foundation-duckdb-labs-and-motherduck-related) between [DuckLabs](https://ducklabs.com) and [MotherDuck](https://motherduck.com/) and is shipped as part of the `ui` extension.
