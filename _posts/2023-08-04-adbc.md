...
<img src="{% link images/blog/adbc/duck-arrow.jpg %}"
     alt="DuckDB-Arrow"
     width="100"
/>
...
<img src="{% link images/blog/adbc/duck-odbc-jdbc-light.png %}"
     alt="DuckDB-JDBC-ODBC"
     width="700"
     class="lightmode-img"
/>
<img src="{% link images/blog/adbc/duck-odbc-jdbc-dark.png %}"
     alt="DuckDB-JDBC-ODBC"
     width="700"
     class="darkmode-img"
/>
...
<img src="{% link images/blog/adbc/duck-adbc-light.png %}"
     alt="DuckDB-ADBC"
     width="700"
     class="lightmode-img"
/>
<img src="{% link images/blog/adbc/duck-adbc-dark.png %}"
     alt="DuckDB-ADBC"
     width="700"
     class="darkmode-img"
/>
...
If you would like to see a more detailed explanation of the DuckDB-ADBC API or view a C++ example, please refer to our [documentation page]({% link docs/current/clients/adbc.md %}).
...
DuckDB-ADBC is currently supported via the C Interface and through the Python ADBC Driver Manager. We will add more extensive tutorials for other languages to our [documentation webpage]({% link docs/current/index.md %}). Please feel free to let us know your preferred language for interacting with DuckDB via ADBC!
