...
| Scale factor | max_memory | Metric | `QUALIFY` | `max_by` | Performance improvement |
|-----------:|----------:|----------:|----------:|----------:|
...
| Scale factor | Threads | Metric | `QUALIFY` | `max_by` | Performance improvement |
|-----------:|----------:|----------:|----------:|----------:|
...
The `max_by` approach is so computationally efficient that even with 1 thread it is dramatically faster than the `QUALIFY` approach can use all threads!
