...
For example, using the [TPC-H data set]({% link docs/extensions/tpch.md %}):
...
|-----------:|----------:|----------:|----------:|----------:|
| 1 | Total Time | 0.58 s | 0.24 s | 2.4× |
| 5 | Total Time | 6.15 s | 1.26 s | 4.9× |
| 10 | Total Time | 36.8 s | 25.4 s | 1.4× |
| 1 | Memory Usage | 0.2 GB | 1.7 GB | 8.5× |
| 5 | Memory Usage | 7.9 GB | 1.5 GB | 5.3× |
| 10 | Memory Usage | 15.7 GB | 17.1 GB | 0.9× |
