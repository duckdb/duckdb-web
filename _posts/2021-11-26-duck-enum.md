...
<img src="{% link images/blog/duck-lotr.png %}"
     alt="dict-enc"
     width="300"
     />
...
<img src="{% link images/blog/dictionary-encoding.png %}"
     alt="dict-enc"
     width="500"
/>
...
See [the documentation]({% link docs/current/sql/data_types/enum.md %}) for more information.
