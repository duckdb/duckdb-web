...
<div align="center">
    <img src="{% link images/blog/csv-vs-parquet-clickbench.png %}"
...
Therefore, this query will stress the filter pushdown, which is [supported by the Parquet reader]({% link docs/current/data/parquet/overview.md %}#partial-reading) but not the CSV reader, and the projection pushdown, which is supported by both.
