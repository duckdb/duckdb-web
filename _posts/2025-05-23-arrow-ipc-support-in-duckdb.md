...
Then you can use [DuckDB's `httpfs` extension]({% link docs/current/core_extensions/httpfs/https.md %}) to query the Arrow data over the HTTP(S) protocol:
