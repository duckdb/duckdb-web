...
Architecture-wise, the Delta extension is available on the platforms `linux_amd64`, `osx_amd64` and `osx_arm64`. Support for the remaining core platforms is coming
...
For details and info on newly added features, keep an eye on the Delta extension [docs]({% link docs/extensions/delta.md %}) and [repository](https://github.com/duckdb/duckdb-delta).
