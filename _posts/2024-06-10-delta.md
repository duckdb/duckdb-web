...
For details and info on newly added features, keep an eye on the Delta extension [docs]({% link docs/stable/extensions/delta.md %}) and [repository](https://github.com/duckdb/duckdb-delta).
