...
DuckDB now supports the [Vortex file format](https://vortex.dev/) through the [`vortex` extension]({% link docs/stable/core_extensions/vortex.md %}) on Linux and macOS.
