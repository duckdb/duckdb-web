...
#
# Live in duckdb/community-extensions since #2037 (v0.9.2). This update bumps
# it to v0.15.0 — see the PR description for what changed since v0.14.1.
...
repo:
  ...
  # tag v0.15.0
  ref: 819d86800e95772740197ac5e3b4ad9a48270aff
...
docs:
  ...
  extended_description: |
    ...
    catalog operations throw. Built and tested against DuckDB v1.5.4 and
    v1.5.5 (v1.5.2/v1.5.3 support was dropped in v0.15.0 — see
    CHANGELOG.md). Full change history in this repo's CHANGELOG.md.
