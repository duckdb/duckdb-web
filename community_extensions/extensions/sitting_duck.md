...
excerpt: |
  ...
  Parse and analyze source code ASTs from 27 programming languages with tree-sitter grammars and pattern matching

extension:
  name: sitting_duck
  description: Parse and analyze source code ASTs from 27 programming languages with tree-sitter grammars and pattern matching
  version: 1.4.0
  language: C++
  build: cmake
  license: MIT
...
repo:
  ...
  ref: c46dfc1a8fd7cb391b109d01fe424a858eb466e9
docs:
  hello_world: |
