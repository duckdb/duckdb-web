...
excerpt: |
  ...
  Read text, metadata, words, lines, and tables from PDF files (with optional Tesseract OCR); write PDFs natively via libharu (`write_pdf` / `COPY … TO FORMAT pdf`); and convert office documents to PDF.
