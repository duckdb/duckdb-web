...
docs:
  ...
  extended_description: |
    ...
    You can also read raster data at the pixel level using the `RT_ReadCells` function, which returns one row per value cell in the raster,
    along with its pixels and spatial coordinates.
...
extension_download_count: 878
extension_download_count_pretty: 878
...
| RT_CoordValue       | scalar        | Returns the value in a specified band of a datacube or filepath[s] at the specified world coordinates (x, y).                                                                                        | NULL    | [SELECT RT_CoordValue(databand_1, 0, 545600.0, 4724500.0, metadata, -9999.0) AS value FROM RT_Read('path/to/raster/file.tif');]                  |
...
| RT_CoordValues      | scalar        | Returns the values in a band of a datacube or filepath[s] at the specified array of world coordinates (x, y).                                                                                        | NULL    | [SELECT RT_CoordValues(databand_1, 0, [545600.0, 545601.0], [4724500.0, 4724501.0], metadata, -9999.0) FROM RT_Read('path/to/raster/file.tif');] |
...
| RT_Metadata         | scalar        | function to retrieve metadata of a raster file as a JSON string.                                                                                                                                     | NULL    | [SELECT * FROM RT_Metadata('path/to/raster/file.tif');]                                                                                          |
...
| RT_RasterValue      | scalar        | Returns the value in a specified band of a datacube or filepath[s] at the specified pixel coordinates (column, row).                                                                                 | NULL    | [SELECT RT_RasterValue(databand_1, 0, 10, 20, -9999.0) FROM RT_Read('path/to/raster/file.tif');]                                                 |
...
| RT_RasterValues     | scalar        | Returns the values in a band of a datacube or filepath[s] at the specified array of pixel coordinates (column, row).                                                                                 | NULL    | [SELECT RT_RasterValues(databand_1, 0, [10, 11], [20, 21], -9999.0) FROM RT_Read('path/to/raster/file.tif');]                                    |
...
| RT_Stats            | scalar        | Calculates statistics for a specific band (0-based index) of a raster, optionally within a geometry.                                                                                                 | NULL    | [SELECT * FROM RT_Stats('path/to/raster/file.tif', 0);]                                                                                          |
