...
DuckDB exploits this, particularly when performing multi-threaded execution.
Other factors, such as using different compilers, operating systems, hardware architectures can also cause changes in ordering.
