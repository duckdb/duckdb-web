...
All [`LIST` functions]({% link docs/1.3/sql/functions/list.md %}) work with the [`ARRAY` data type]({% link docs/1.3/sql/data_types/array.md %}). Additionally, several `ARRAY`-native functions are also supported.
