...
(or `TIMESTAMPTZ`) values]({% link docs/1.3/sql/data_types/timestamp.md %}). See also the related [`TIMESTAMP` functions]({% link docs/1.3/sql/functions/timestamp.md %}).

Time zone support is provided by the built-in [ICU extension]({% link docs/1.3/core_extensions/icu.md %}).
...
| [`date_part([part, ...], timestamptz)`](#date_partpart--timestamptz) | Get the listed [subfields]({% link docs/1.3/sql/functions/datepart.md %}) as a `struct`. The list must be constant. |
| [`date_part(part, timestamptz)`](#date_partpart-timestamptz) | Get [subfield]({% link docs/1.3/sql/functions/datepart.md %}) (equivalent to *extract*). |
...
| [`date_trunc(part, timestamptz)`](#date_truncpart-timestamptz) | Truncate to specified [precision]({% link docs/1.3/sql/functions/datepart.md %}). |
...
| [`datepart([part, ...], timestamptz)`](#datepartpart--timestamptz) | Alias of date_part. Get the listed [subfields]({% link docs/1.3/sql/functions/datepart.md %}) as a `struct`. The list must be constant. |
| [`datepart(part, timestamptz)`](#datepartpart-timestamptz) | Alias of date_part. Get [subfield]({% link docs/1.3/sql/functions/datepart.md %}) (equivalent to *extract*). |
...
| [`datetrunc(part, timestamptz)`](#datetruncpart-timestamptz) | Alias of date_trunc. Truncate to specified [precision]({% link docs/1.3/sql/functions/datepart.md %}). |
...
| [`extract(field FROM timestamptz)`](#extractfield-from-timestamptz) | Get [subfield]({% link docs/1.3/sql/functions/datepart.md %}) from a `TIMESTAMP WITH TIME ZONE`. |
...
| [`strftime(timestamptz, format)`](#strftimetimestamptz-format) | Converts a `TIMESTAMP WITH TIME ZONE` value to string according to the [format string]({% link docs/1.3/sql/functions/dateformat.md %}#format-specifiers). |
| [`strptime(text, format)`](#strptimetext-format) | Converts string to `TIMESTAMP WITH TIME ZONE` according to the [format string]({% link docs/1.3/sql/functions/dateformat.md %}#format-specifiers) if `%Z` is specified. |
...
| **Description** | Get [subfield]({% link docs/1.3/sql/functions/datepart.md %}) from a `TIMESTAMP WITH TIME ZONE`. |
...
| **Description** | Converts a `TIMESTAMP WITH TIME ZONE` value to string according to the [format string]({% link docs/1.3/sql/functions/dateformat.md %}#format-specifiers). |
...
| **Description** | Converts string to `TIMESTAMP WITH TIME ZONE` according to the [format string]({% link docs/1.3/sql/functions/dateformat.md %}#format-specifiers) if `%Z` is specified. |
...
| [`timezone(text, timestamp)`](#timezonetext-timestamp) | Use the [date parts]({% link docs/1.3/sql/functions/datepart.md %}) of the timestamp in GMT to construct a timestamp in the given time zone. Effectively, the argument is a “local” time. |
| [`timezone(text, timestamptz)`](#timezonetext-timestamptz) | Use the [date parts]({% link docs/1.3/sql/functions/datepart.md %}) of the timestamp in the given time zone to construct a timestamp. Effectively, the result is a “local” time. |
...
| **Description** | Use the [date parts]({% link docs/1.3/sql/functions/datepart.md %}) of the timestamp in GMT to construct a timestamp in the given time zone. Effectively, the argument is a “local” time. |
...
| **Description** | Use the [date parts]({% link docs/1.3/sql/functions/datepart.md %}) of the timestamp in the given time zone to construct a timestamp. Effectively, the result is a “local” time. |
...
The ICU extension also supports [non-Gregorian calendars]({% link docs/1.3/sql/data_types/timestamp.md %}#calendar-support).
