...
See [Logical Operators]({% link docs/1.3/sql/expressions/logical_operators.md %}) and [Comparison Operators]({% link docs/1.3/sql/expressions/comparison_operators.md %}).
