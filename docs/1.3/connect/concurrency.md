...
2. Multiple processes can read from the database, but no processes can write ([`access_mode = 'READ_ONLY'`]({% link docs/1.3/configuration/overview.md %}#configuration-reference)).
