...
For platform-specific details, see the pages for [Linux]({% link docs/1.3/clients/odbc/linux.md %}), [macOS]({% link docs/1.3/clients/odbc/macos.md %}), and [Windows]({% link docs/1.3/clients/odbc/windows.md %}).
