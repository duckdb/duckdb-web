...
> The latest version of the DuckDB Rust client is {{ site.current_duckdb_rust_version }}.
...
The Rust client supports the [DuckDB Appender API]({% link docs/1.3/data/appender.md %}) for bulk inserts. For example:
