...
The shell offers context-aware autocomplete of SQL queries through the [`autocomplete` extension]({% link docs/1.3/core_extensions/autocomplete.md %}). autocomplete is triggered by pressing `Tab`.
