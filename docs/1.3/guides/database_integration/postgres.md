...
To run a query directly on a running PostgreSQL database, the [`postgres` extension]({% link docs/1.3/core_extensions/postgres.md %}) is required.
...
For more information see the [PostgreSQL extension documentation]({% link docs/1.3/core_extensions/postgres.md %}).
