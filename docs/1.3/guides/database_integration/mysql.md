...
To run a query directly on a running MySQL database, the [`mysql` extension]({% link docs/1.3/core_extensions/mysql.md %}) is required.
...
For a list of supported operations, see the [MySQL extension documentation]({% link docs/1.3/core_extensions/mysql.md %}#supported-operations).
