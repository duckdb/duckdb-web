...
For additional options, see the [JSON Loading reference]({% link docs/1.3/data/json/overview.md %}) and the [`COPY` statement documentation]({% link docs/1.3/sql/statements/copy.md %}).
