...
* [range functions]({% link docs/1.3/sql/functions/list.md %}#range-functions)
* hash functions, e.g.,
  [`hash`]({% link docs/1.3/sql/functions/utility.md %}#hashvalue),
  [`md5`]({% link docs/1.3/sql/functions/utility.md %}#md5string),
  [`sha256`]({% link docs/1.3/sql/functions/utility.md %}#sha256value)
* the [Faker Python package](https://faker.readthedocs.io/) via the [Python function API]({% link docs/1.3/clients/python/function.md %})
* using [cross products (Cartesian products)]({% link docs/1.3/sql/query_syntax/from.md %}#cross-product-joins-cartesian-product)
