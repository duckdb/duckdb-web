...
Install the [`httpfs`]({% link docs/lts/core_extensions/httpfs/overview.md %}) extension:
...
Load the [`httpfs`]({% link docs/lts/core_extensions/httpfs/overview.md %}) extension:

```sql
LOAD httpfs;
```

Load the [`spatial`]({% link docs/lts/core_extensions/spatial/overview.md %}) extension:
