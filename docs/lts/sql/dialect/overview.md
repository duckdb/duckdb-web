...
For example, interchangeability with data frame libraries necessitates [order preservation of inserts]({% link docs/lts/sql/dialect/order_preservation.md %}) to be supported by default.
