...
To retrieve the version of a UUID value, use the [`uuid_extract_version` function]({% link docs/lts/sql/functions/utility.md %}#uuid_extract_versionuuid).

### UUIDv4

To generate a UUIDv4 value, use the
[`uuid()` function]({% link docs/lts/sql/functions/utility.md %}#uuid) or its aliases
the [`uuidv4()`]({% link docs/lts/sql/functions/utility.md %}#uuidv4) and [`gen_random_uuid()`]({% link docs/lts/sql/functions/utility.md %}#gen_random_uuid)
functions.

### UUIDv7

To generate a UUIDv7 value, use the [`uuidv7()`]({% link docs/lts/sql/functions/utility.md %}#uuidv7) function.
To retrieve the timestamp from a UUIDv7 value, use the [`uuid_extract_timestamp` function]({% link docs/lts/sql/functions/utility.md %}#uuid_extract_timestampuuidv7):
...
See [Numeric Functions and Operators]({% link docs/lts/sql/functions/numeric.md %}).
