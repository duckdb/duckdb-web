...
* [string literals]({% link docs/lts/sql/data_types/literal_types.md %}#string-literals)
* [casting]({% link docs/lts/sql/expressions/cast.md %}#explicit-casting) expressions to a text type
* applying a [string operator]({% link docs/lts/sql/functions/text.md %}#text-functions-and-operators), or invoking a function that returns a text type value

## Strings with Special Characters

To use special characters in a string, use [escape string literals]({% link docs/lts/sql/data_types/literal_types.md %}#escape-string-literals) or [dollar-quoted string literals]({% link docs/lts/sql/data_types/literal_types.md %}#dollar-quoted-string-literals). Alternatively, you can use concatenation and the [`chr` character function]({% link docs/lts/sql/functions/text.md %}):
...
See [Text Functions]({% link docs/lts/sql/functions/text.md %}) and [Pattern Matching]({% link docs/lts/sql/functions/pattern_matching.md %}).
