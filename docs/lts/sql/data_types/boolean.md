...
See [Logical Operators]({% link docs/lts/sql/expressions/logical_operators.md %}) and [Comparison Operators]({% link docs/lts/sql/expressions/comparison_operators.md %}).
