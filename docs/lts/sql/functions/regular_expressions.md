...
DuckDB offers [pattern matching operators]({% link docs/lts/sql/functions/pattern_matching.md %})
([`LIKE`]({% link docs/lts/sql/functions/pattern_matching.md %}#like),
[`SIMILAR TO`]({% link docs/lts/sql/functions/pattern_matching.md %}#similar-to),
[`GLOB`]({% link docs/lts/sql/functions/pattern_matching.md %}#glob)),
