...
layout: docu
redirect_from:
- /docs/lts/extensions/iceberg/amazon_s3_tables
...
You can let DuckDB detect your AWS credentials and configuration based on the default profile in your `~/.aws` directory by creating the following secret using the [Secrets Manager]({% link docs/lts/configuration/secrets_manager.md %}):
