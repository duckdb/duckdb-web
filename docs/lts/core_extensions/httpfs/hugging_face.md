...
To query all files under a specific directory, you can use a [glob pattern]({% link docs/lts/data/multiple_files/overview.md %}#multi-file-reads-and-globs). For example:
