...
The `ducklake` extension will be transparently [autoloaded]({% link docs/lts/core_extensions/overview.md %}#autoloading-extensions) on first use in an `ATTACH` clause.
