...
Using the [DuckDB CLI client]({% link docs/lts/clients/cli/overview.md %}),
you can start the UI with a CSV available as a view using the [`-cmd` argument]({% link docs/lts/clients/cli/arguments.md %}):
