...
2. Multiple processes can read from the database, but no processes can write ([`access_mode = 'READ_ONLY'`]({% link docs/lts/configuration/overview.md %}#configuration-reference)).
