...
When you are running on an experimental platform (e.g., [Raspberry Pi]({% link docs/lts/dev/building/raspberry_pi.md %})) or you would like to build the project for an unmerged pull request,
...
See [Build Configuration]({% link docs/lts/dev/building/build_configuration.md %}) for targets and configuration flags.
...
* [Linux]({% link docs/lts/dev/building/linux.md %})
* [macOS]({% link docs/lts/dev/building/macos.md %})
* [Windows]({% link docs/lts/dev/building/windows.md %})

### Platforms with Partial Support

There are several partially supported platforms.
For some platforms, DuckDB binaries and extensions (or a [subset of extensions]({% link docs/lts/extensions/extension_distribution.md %}#platforms)) are distributed.
...
* [Android]({% link docs/lts/dev/building/android.md %})
* [Raspberry Pi]({% link docs/lts/dev/building/raspberry_pi.md %})
...
See also the [“Unofficial and Unsupported Platforms” page]({% link docs/lts/dev/building/unofficial_and_unsupported_platforms.md %}) for details.
...
* [Generic issues]({% link docs/lts/dev/building/troubleshooting.md %})
* [Python]({% link docs/lts/dev/building/python.md %})
* [R]({% link docs/lts/dev/building/r.md %})
