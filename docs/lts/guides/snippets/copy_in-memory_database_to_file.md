...
To achieve this, **attach to a new disk-based database** and use the [`COPY FROM DATABASE ... TO` command]({% link docs/lts/sql/statements/copy.md %}#copy-from-database--to):
