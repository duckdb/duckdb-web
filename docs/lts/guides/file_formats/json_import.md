...
For additional options, see the [JSON Loading reference]({% link docs/lts/data/json/overview.md %}) and the [`COPY` statement documentation]({% link docs/lts/sql/statements/copy.md %}).
