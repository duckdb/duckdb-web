...
DuckDB can also [import Excel files]({% link docs/lts/guides/file_formats/excel_import.md %}).
For additional details on Excel support, see the [`excel` extension page]({% link docs/lts/core_extensions/excel.md %}).
