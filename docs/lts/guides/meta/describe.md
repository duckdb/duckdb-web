...
It is possible to describe remote tables via the [`httpfs` extension]({% link docs/lts/core_extensions/httpfs/overview.md %}) using the `DESCRIBE TABLE` statement. For example:
