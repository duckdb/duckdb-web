...
> The DuckDB PHP client is a [tertiary client]({% link docs/lts/clients/overview.md %}) and is maintained by a third-party.
...
Appenders are the preferred method to load data in DuckDB. See [Appender page]({% link docs/lts/clients/c/appender.md %})
