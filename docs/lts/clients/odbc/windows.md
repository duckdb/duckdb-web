...
2. <!-- markdownlint-disable MD034 --> DuckDB releases the ODBC driver as an asset. For Windows, download it from the [Windows ODBC asset (x86_64/AMD64)](https://github.com/duckdb/duckdb-odbc/releases/download/v{{ site.lts_duckdb_odbc_version }}/duckdb_odbc-windows-amd64.zip). <!-- markdownlint-enable MD034 -->
...
Furthermore, the ODBC driver supports all the [configuration options]({% link docs/lts/configuration/overview.md %})
included in DuckDB.
