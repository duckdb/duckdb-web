...
For platform-specific details, see the pages for [Linux]({% link docs/lts/clients/odbc/linux.md %}), [macOS]({% link docs/lts/clients/odbc/macos.md %}), and [Windows]({% link docs/lts/clients/odbc/windows.md %}).
