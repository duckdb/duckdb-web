...
All statements are translated to DuckDB's internal plans using our [relational API]({% link docs/lts/clients/python/relational_api.md %}) and executed using DuckDB's query engine.
