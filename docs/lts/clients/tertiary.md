...
| [Dart]({% link docs/lts/clients/dart.md %})       | [TigerEye](https://www.tigereye.com/)                 | Tertiary     |
...
| [Haskell](https://github.com/tritlo/duckdb-haskell)  | [Tritlo](https://github.com/tritlo)                   | Tertiary     |
| [Julia]({% link docs/lts/clients/julia.md %})     | The DuckDB team                                       | Tertiary     |
| [Perl](https://metacpan.org/pod/DBD::DuckDB)         | [Giuseppe Di Terlizzi](https://github.com/giterlizzi) | Tertiary     |
| [PHP]({% link docs/lts/clients/php.md %})         | [satur-io](https://github.com/satur-io/duckdb-php)    | Tertiary     |
...
| [Swift]({% link docs/lts/clients/swift.md %})     | The DuckDB team                                       | Tertiary     |
| [Zig](https://github.com/karlseguin/zuckdb.zig)      | [karlseguin](https://github.com/karlseguin)           | Tertiary     |

## Support Tiers

There are three tiers of support for clients. [Primary clients and secondary clients]({% link docs/lts/clients/overview.md %}) are guaranteed to receive new features. For tertiary clients, there are no such guarantees as most are maintained by third-party contributors.
