...
This is equivalent to the SQL construct [`UNION ALL`]({% link docs/lts/sql/query_syntax/setops.md %}#union-all).
...
This is equivalent to the SQL construct [`UNION ALL BY NAME`]({% link docs/lts/sql/query_syntax/setops.md %}#union-all-by-name).
