...
In the [C++ API]({% link docs/lts/clients/cpp.md %}), the Appender works as follows:
...
You can change this by explicitly using [transactions]({% link docs/lts/sql/statements/transactions.md %}) and surrounding your batches of `AppendRow` calls by `BEGIN TRANSACTION` and `COMMIT` statements.
...
* [C]({% link docs/lts/clients/c/appender.md %})
* [Go]({% link docs/lts/clients/go.md %}#appender)
* [Java (JDBC)]({% link docs/lts/clients/java.md %}#appender)
* [Julia]({% link docs/lts/clients/julia.md %}#appender-api)
* [Rust]({% link docs/lts/clients/rust.md %}#appender)
* [Node.js]({% link docs/lts/clients/node_neo/overview.md %}#append-to-table)
