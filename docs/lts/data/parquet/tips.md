...
Using a [glob pattern]({% link docs/lts/data/multiple_files/overview.md %}#glob-syntax) upon read or a [Hive partitioning]({% link docs/lts/data/partitioning/hive_partitioning.md %}) structure are good ways to transparently handle multiple files.
...
See the [Performance Guide on “File Formats”]({% link docs/lts/guides/performance/file_formats.md %}#parquet-file-sizes) for more tips.
