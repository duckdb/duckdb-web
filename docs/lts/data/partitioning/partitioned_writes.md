...
To handle slashes in column names, use Percent-Encoding implemented by the [`url_encode` function]({% link docs/lts/sql/functions/text.md %}#url_encodestring).
