...
redirect_from:
- /docs/preview/sql/statements/create_index
- /docs/sql/statements/create_index
- /docs/stable/sql/statements/create_index
...
| `index type` | Specified index type, see [Indexes]({% link docs/current/sql/indexes.md %}). Optional. |
