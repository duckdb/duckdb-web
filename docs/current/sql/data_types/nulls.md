...
For details, see the [Boolean Type documentation]({% link docs/current/sql/data_types/boolean.md %}).
...
For details, see the [`IN` documentation]({% link docs/current/sql/expressions/in.md %}).
