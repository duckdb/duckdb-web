...
layout: docu
redirect_from:
- /docs/preview/sql/data_types/boolean
...
See [Logical Operators]({% link docs/current/sql/expressions/logical_operators.md %}) and [Comparison Operators]({% link docs/current/sql/expressions/comparison_operators.md %}).
