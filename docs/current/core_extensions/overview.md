...
| [postgres]({% link docs/current/core_extensions/postgres/overview.md %})  | Adds support for reading from and writing to a PostgreSQL database      | DuckDB&nbsp;team | {% include tooltip.html label="Secondary" id="support_tier_secondary_extension" %} | postgres_scanner        |
