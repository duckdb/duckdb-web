...
- /docs/lts/extensions/httpfs/hugging_face
...
To query all files under a specific directory, you can use a [glob pattern]({% link docs/current/data/multiple_files/overview.md %}#multi-file-reads-and-globs). For example:
