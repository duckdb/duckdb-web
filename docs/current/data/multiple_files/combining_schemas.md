...
- /docs/preview/data/multiple_files/combining_schemas
- /docs/stable/data/multiple_files/combining_schemas
...
This is equivalent to the SQL construct [`UNION ALL`]({% link docs/current/sql/query_syntax/setops.md %}#union-all).
...
This is equivalent to the SQL construct [`UNION ALL BY NAME`]({% link docs/current/sql/query_syntax/setops.md %}#union-all-by-name).
