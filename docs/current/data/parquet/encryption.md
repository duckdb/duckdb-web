...
- /docs/preview/data/parquet/encryption
- /docs/stable/data/parquet/encryption
...
Without encryption, reading/writing the `lineitem` table from [`TPC-H`]({% link docs/current/core_extensions/tpch.md %}) at SF1, which is 6M rows and 15 columns, from/to a Parquet file takes 0.26 and 0.99 seconds, respectively.
