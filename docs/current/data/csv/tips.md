...
redirect_from:
- /docs/data/csv/tips
- /docs/preview/data/csv/tips
- /docs/stable/data/csv/tips
...
The [`COPY` statement]({% link docs/current/sql/statements/copy.md %}) copies data directly into a table. The CSV reader uses the schema of the table instead of auto-detecting types from the file. This speeds up the auto-detection, and prevents mistakes from being made during auto-detection.
