...
* [`duckdb-quack`](https://github.com/duckdb/duckdb-quack): Quack remote protocol
...
* Core extension repositories are linked in the [Official Extensions page]({% link docs/current/core_extensions/overview.md %})
