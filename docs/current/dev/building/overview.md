...
When you are running on an experimental platform (e.g., [Raspberry Pi]({% link docs/current/dev/building/raspberry_pi.md %})) or you would like to build the project for an unmerged pull request,
...
* [Linux]({% link docs/current/dev/building/linux.md %})
* [macOS]({% link docs/current/dev/building/macos.md %})
* [Windows]({% link docs/current/dev/building/windows.md %})

### Platforms with Partial Support

There are several partially supported platforms.
For some platforms, DuckDB binaries and extensions (or a [subset of extensions]({% link docs/current/extensions/extension_distribution.md %}#platforms)) are distributed.
...
* [Android]({% link docs/current/dev/building/android.md %})
* [Raspberry Pi]({% link docs/current/dev/building/raspberry_pi.md %})
...
* [Generic issues]({% link docs/current/dev/building/troubleshooting.md %})
* [Python]({% link docs/current/dev/building/python.md %})
* [R]({% link docs/current/dev/building/r.md %})
