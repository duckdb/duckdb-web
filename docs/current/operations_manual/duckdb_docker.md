...
layout: docu
redirect_from:
- /docs/preview/operations_manual/duckdb_docker
- /docs/stable/operations_manual/duckdb_docker
...
To use the [DuckDB UI]({% link docs/current/core_extensions/ui.md %}) with Docker, enable host networking.
