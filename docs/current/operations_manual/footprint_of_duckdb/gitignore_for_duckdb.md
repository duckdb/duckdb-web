...
- /docs/preview/operations_manual/footprint_of_duckdb/gitignore_for_duckdb
- /docs/stable/operations_manual/footprint_of_duckdb/gitignore_for_duckdb
title: Gitignore for DuckDB
---

If you work in a Git repository, you may want to configure your [Gitignore](https://git-scm.com/docs/gitignore) to disable tracking [files created by DuckDB]({% link docs/current/operations_manual/footprint_of_duckdb/files_created_by_duckdb.md %}).
