...
For platform-specific details, see the pages for [Linux]({% link docs/current/clients/odbc/linux.md %}), [macOS]({% link docs/current/clients/odbc/macos.md %}), and [Windows]({% link docs/current/clients/odbc/windows.md %}).
