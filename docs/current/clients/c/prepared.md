...
- /docs/preview/clients/c/prepared
...
> Warning Do **not** use prepared statements to insert large amounts of data into DuckDB. Instead it is recommended to use the [Appender]({% link docs/current/clients/c/appender.md %}).
