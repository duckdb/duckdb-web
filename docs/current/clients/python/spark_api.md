...
- /docs/preview/clients/python/spark_api
- /docs/stable/clients/python/spark_api
title: Spark API
---
...
All statements are translated to DuckDB's internal plans using our [relational API]({% link docs/current/clients/python/relational_api.md %}) and executed using DuckDB's query engine.
