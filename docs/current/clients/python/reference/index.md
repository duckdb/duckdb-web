...
- /docs/preview/clients/python/reference/index
- /docs/stable/clients/python/reference/index
...
<dd>
<p>Bases: <code class="xref py py-class docutils literal notranslate"><span class="pre">pybind11_object</span></code></p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}">Relational API page</a>.</div>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#aggregate">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#alias">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#any_value">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#apply">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#arg_max">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#arg_min">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Alias of to_arrow_reader(). We recommend using to_arrow_reader() instead.</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#arrow">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#avg">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#bit_and">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#bit_or">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#bit_xor">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#bitstring_agg">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#bool_and">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#bool_or">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#close">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#columns">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#count">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#create">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#create_view">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#cross">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#cume_dist">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#dense_rank">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#describe">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#description">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#df">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#distinct">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#dtypes">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#except_">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#execute">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#explain">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#favg">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#fetch_arrow_reader">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#fetch_arrow_table">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#fetch_df_chunk">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Execute and return an Arrow Record Batch Reader that yields all rows</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#fetch_record_batch">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#fetchall">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Execute and fetch all rows as a pandas DataFrame</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#fetchdf">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#fetchmany">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#fetchnumpy">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#fetchone">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#filter">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#first">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#first_value">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#fsum">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#geomean">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#histogram">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#insert">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#insert_into">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#intersect">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#join">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#lag">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#last">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#last_value">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#lead">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#limit">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#list">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#map">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#max">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Computes the average of a given expression</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#mean">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#median">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#min">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#mode">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#n_tile">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#nth_value">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#order">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#percent_rank">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#pl">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#product">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#project">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#quantile">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#quantile_cont">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Computes the exact quantile value for a given expression</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#quantile_disc">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#query">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#rank">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Computes the dense rank within the partition</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#rank_dense">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#row_number">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Project the relation object by the projection in project_expr</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#select">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#select_dtypes">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Select columns from the relation, by filtering based on type(s)</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#select_types">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#set_alias">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#shape">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#show">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#sort">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#sql_query">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#std">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Computes the sample standard deviation for a given expression</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#stddev">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#stddev_pop">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Computes the sample standard deviation for a given expression</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#stddev_samp">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#string_agg">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#sum">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#tf">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Execute and return an Arrow Record Batch Reader that yields all rows</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#to_arrow_reader">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Execute and fetch all rows as an Arrow Table</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#to_arrow_table">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#to_csv">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Execute and fetch all rows as a pandas DataFrame</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#to_df">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#to_parquet">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Creates a new table named table_name with the contents of the relation object</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#to_table">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Creates a view named view_name that refers to the relation object</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#to_view">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#torch">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#type">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Return a list containing the types of the columns of the relation.</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#types">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#union">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#unique">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#update">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#value_counts">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#var">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#var_pop">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Computes the sample variance for a given expression</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#var_samp">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Computes the sample variance for a given expression</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#variance">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Write the relation object to a CSV file in &#8216;file_name&#8217;</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#write_csv">Relational API page</a>.</div>
<br>
</dd>
</dl>
...
<dd>
<p>Write the relation object to a Parquet file in &#8216;file_name&#8217;</p>
<div>Detailed examples can be found at <a href="{% link docs/current/clients/python/relational_api.md %}#write_parquet">Relational API page</a>.</div>
<br>
</dd>
</dl>
