...
- /docs/stable/clients/tertiary_clients/php
title: PHP Client
---

> The DuckDB PHP client is a [tertiary client]({% link docs/current/clients/overview.md %}) and is maintained by a third-party.
...
Appenders are the preferred method to load data in DuckDB. See [Appender page]({% link docs/current/clients/c/appender.md %})
