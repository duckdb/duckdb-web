...
- /docs/preview/guides/snippets/sharing_macros
- /docs/stable/guides/snippets/sharing_macros
title: Sharing Macros
---

DuckDB has a powerful [macro mechanism]({% link docs/current/sql/statements/create_macro.md %}) that allows creating shorthands for common tasks.
...
Make sure that the [`httpfs` extension]({% link docs/current/core_extensions/httpfs/overview.md %}) is installed:
...
To use it, make sure that the [`httpfs` extension]({% link docs/current/core_extensions/httpfs/overview.md %}) is installed:
