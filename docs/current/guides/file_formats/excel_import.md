...
DuckDB can also [export Excel files]({% link docs/current/guides/file_formats/excel_export.md %}).
For additional details on Excel support, see the [excel extension page]({% link docs/current/core_extensions/excel.md %}).
