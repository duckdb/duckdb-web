...
- /docs/preview/guides/odbc/general
- /docs/stable/guides/odbc/general
...
> To install the driver as well as anything else you will need follow these [instructions]({% link docs/current/clients/odbc/overview.md %}).
