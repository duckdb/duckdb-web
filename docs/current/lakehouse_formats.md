...
| ---------------------------- | :-------------------------------------------------------------------- | :---------------------------------------------------------------------- | :--------------------------------------------------------- | :--------------------------------------------------------- |
| Extension                    | [`ducklake`](https://ducklake.select/docs/stable/duckdb/introduction) | [`iceberg`]({% link docs/current/core_extensions/iceberg/overview.md %}) | [`delta`]({% link docs/current/core_extensions/delta.md %}) | [`lance`]({% link docs/current/core_extensions/lance.md %}) |
| Read                         | ✅                                                                    | ✅                                                                      | ✅                                                         | ✅                                                         |
| Write                        | ✅                                                                    | ✅                                                                      | ✅                                                         | ✅                                                         |
| Deletes                      | ✅                                                                    | ✅                                                                      | ❌                                                         | ✅                                                         |
| Updates                      | ✅                                                                    | ✅                                                                      | ❌                                                         | ✅                                                         |
