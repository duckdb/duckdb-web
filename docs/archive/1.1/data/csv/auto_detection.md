...
The set of candidate types that should be considered by the CSV reader can be explicitly specified using the [`auto_type_candidates`]({% link docs/archive/1.1/data/csv/overview.md %}#auto_type_candidates-details) option.
