...
To read data from an Excel file, install and load the [spatial extension]({% link docs/archive/1.1/extensions/spatial/overview.md %}).
...
DuckDB can also [export Excel files]({% link docs/archive/1.1/guides/file_formats/excel_export.md %}).
For additional details on Excel support, see the [spatial extension page]({% link docs/archive/1.1/extensions/spatial/overview.md %}), the [GDAL XLSX driver page](https://gdal.org/drivers/vector/xlsx.html), and the [GDAL configuration options page](https://gdal.org/user/configoptions.html#configoptions).