...
* [range functions]({% link docs/archive/1.1/sql/functions/list.md %}#range-functions)
* hash functions, e.g.,
  [`hash`]({% link docs/archive/1.1/sql/functions/utility.md %}#hashvalue),
  [`md5`]({% link docs/archive/1.1/sql/functions/utility.md %}#md5string),
  [`sha256`]({% link docs/archive/1.1/sql/functions/utility.md %}#sha256value)
* the [Faker Python package](https://faker.readthedocs.io/) via the [Python function API]({% link docs/archive/1.1/api/python/function.md %})
* using [cross products (Cartesian products)]({% link docs/archive/1.1/sql/query_syntax/from.md %}#cross-product-joins-cartesian-product)
