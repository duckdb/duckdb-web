...
layout: docu
redirect_from:
- /docs/archive/1.1/api/nodejs
- /docs/archive/1.1/api/nodejs/
title: Node.js API
---

> Deprecated The old DuckDB Node.js package is deprecated.
> Please use the [DuckDB Node Neo package]({% link docs/archive/1.1/api/node_neo/overview.md %}) instead.
...
All options as described on [Database configuration]({% link docs/archive/1.1/configuration/overview.md %}#configuration-reference) can be (optionally) supplied to the `Database` constructor as second argument. The third argument can be optionally supplied to get feedback on the given options.
...
[Apache Arrow]({% link docs/archive/1.1/guides/python/sql_on_arrow.md %}) can be used to insert data into DuckDB without making a copy:
...
To load [unsigned extensions]({% link docs/archive/1.1/extensions/overview.md %}#ensuring-the-integrity-of-extensions), instantiate the database as follows:
