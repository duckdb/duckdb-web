...
DuckDB offers [pattern matching operators]({% link docs/archive/1.1/sql/functions/pattern_matching.md %})
([`LIKE`]({% link docs/archive/1.1/sql/functions/pattern_matching.md %}#like),
[`SIMILAR TO`]({% link docs/archive/1.1/sql/functions/pattern_matching.md %}#similar-to),
[`GLOB`]({% link docs/archive/1.1/sql/functions/pattern_matching.md %}#glob)),
