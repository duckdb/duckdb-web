...
To work around this, enforce uniqueness using [`DISTINCT ON`]({% link docs/archive/1.1/sql/query_syntax/select.md %}#distinct-on-clause). For example:
