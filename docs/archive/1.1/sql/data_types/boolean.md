...
See [Logical Operators]({% link docs/archive/1.1/sql/expressions/logical_operators.md %}) and [Comparison Operators]({% link docs/archive/1.1/sql/expressions/comparison_operators.md %}).