...
To generate a new UUID, use the [`uuid()` utility function]({% link docs/archive/1.1/sql/functions/utility.md %}#uuid).

## Functions

See [Numeric Functions and Operators]({% link docs/archive/1.1/sql/functions/numeric.md %}).