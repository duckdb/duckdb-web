...
See [Logical Operators]({% link docs/archive/1.0/sql/expressions/logical_operators.md %}) and [Comparison Operators]({% link docs/archive/1.0/sql/expressions/comparison_operators.md %}).