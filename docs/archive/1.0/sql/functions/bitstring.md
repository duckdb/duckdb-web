...
layout: docu
redirect_from:
- docs/archive/1.0/test/functions/bitstring
title: Bitstring Functions
---

<!-- markdownlint-disable MD001 -->

This section describes functions and operators for examining and manipulating [`BITSTRING`]({% link docs/archive/1.0/sql/data_types/bitstring.md %}) values.
