...
To work around this, enforce uniqueness using [`DISTINCT ON`]({% link docs/archive/1.0/sql/query_syntax/select.md %}#distinct-on-clause). For example:
