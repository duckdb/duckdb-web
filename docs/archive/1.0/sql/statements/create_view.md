...
The SQL query behind an existing view can be read using the [`duckdb_views()` function]({% link docs/archive/1.0/sql/meta/duckdb_table_functions.md %}#duckdb_views) like this:
