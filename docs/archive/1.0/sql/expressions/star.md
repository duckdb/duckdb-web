...
See the [`STRUCT` data type]({% link docs/archive/1.0/sql/data_types/struct.md %}) and [nested functions]({% link docs/archive/1.0/sql/functions/nested.md %}) pages for more details on working with structs.
