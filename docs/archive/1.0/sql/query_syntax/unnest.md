...
To keep track of each entry's position within the original list, `unnest` may be combined with [`generate_subscripts`]({% link docs/archive/1.0/sql/functions/nested.md %}#generate_subscripts):
