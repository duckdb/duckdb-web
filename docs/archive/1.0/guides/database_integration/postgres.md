...
layout: docu
redirect_from:
- /docs/archive/1.0/guides/import/query_postgres
title: PostgreSQL Import
---

To run a query directly on a running PostgreSQL database, the [`postgres` extension]({% link docs/archive/1.0/extensions/postgres.md %}) is required.
...
For more information see the [PostgreSQL extension documentation]({% link docs/archive/1.0/extensions/postgres.md %}).