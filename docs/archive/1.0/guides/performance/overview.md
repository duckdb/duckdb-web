...
layout: docu
redirect_from:
- /docs/archive/1.0/guides/performance
...
The guides include several microbenchmarks. You may find details about these on the [Benchmarks page]({% link docs/archive/1.0/guides/performance/benchmarks.md %}).