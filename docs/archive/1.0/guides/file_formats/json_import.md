...
For additional options, see the [JSON Loading reference]({% link docs/archive/1.0/data/json/overview.md %}) and the [`COPY` statement documentation]({% link docs/archive/1.0/sql/statements/copy.md %}).