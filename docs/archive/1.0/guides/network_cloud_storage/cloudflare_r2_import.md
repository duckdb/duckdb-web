...
layout: docu
redirect_from:
- /docs/archive/1.0/guides/import/cloudflare_r2_import
...
This requires the [`httpfs` extension]({% link docs/archive/1.0/extensions/httpfs/overview.md %}), which can be installed using the `INSTALL` SQL command. This only needs to be run once.
