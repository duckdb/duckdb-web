...
Please see the [installation page]({% link docs/archive/1.0/installation/index.html %}?environment=r) for details.
...
Also refer to [the data import documentation]({% link docs/archive/1.0/data/overview.md %}) for more options of efficiently importing data.
...
You can use the [`memory_limit` configuration option]({% link docs/archive/1.0/configuration/pragmas.md %}) to limit the memory use of DuckDB, e.g.:
