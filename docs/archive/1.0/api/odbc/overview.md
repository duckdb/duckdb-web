...
The ODBC driver is available for all operating systems. Visit the [installation page]({% link docs/archive/1.0/installation/index.html %}) for direct links.