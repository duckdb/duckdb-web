...
2. <!-- markdownlint-disable MD034 --> DuckDB releases the ODBC driver as an asset. For Windows, download it from the [Windows ODBC asset (x86_64/AMD64)](https://github.com/duckdb/duckdb/releases/download/v1.0.0/duckdb_odbc-windows-amd64.zip). <!-- markdownlint-enable MD034 -->
...
Furthermore, the ODBC driver supports all the [configuration options]({% link docs/archive/1.0/configuration/overview.md %})
included in DuckDB.
