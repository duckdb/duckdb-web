...
layout: docu
redirect_from:
- /docs/archive/1.0/api/python/result_conversion
...
This is a mapping of Python object types to DuckDB [Logical Types]({% link docs/archive/1.0/sql/data_types/overview.md %}):
...
Below are some examples using this functionality. See the [Python guides]({% link docs/archive/1.0/guides/overview.md %}#python-client) for more examples.
