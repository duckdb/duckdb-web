...
layout: docu
redirect_from:
- /docs/archive/1.0/data/csv/multiple_files
...
See the [combining schemas]({% link docs/archive/1.0/data/multiple_files/combining_schemas.md %}) page for tips on reading files with different schemas.
