...
This is equivalent to the SQL construct [`UNION ALL`]({% link docs/archive/1.0/sql/query_syntax/setops.md %}#union-all).
...
This is equivalent to the SQL construct [`UNION ALL BY NAME`]({% link docs/archive/1.0/sql/query_syntax/setops.md %}#union-all-by-name).
