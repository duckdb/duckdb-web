...
#### List Parameter
The read_parquet function can accept a list of filenames as the input parameter. See the [nested types documentation](/docs/sql/data_types/overview) for more details on lists.
```sql
