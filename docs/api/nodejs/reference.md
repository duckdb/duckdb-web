...
- [duckdb](#duckdb)
  - [duckdb~Connection](#duckdbconnection)
    - [connection.run(sql, ...params, callback) ⇒ void](#connectionrunsql-params-callback--void)
    - [connection.all(sql, ...params, callback) ⇒ void](#connectionallsql-params-callback--void)
    - [connection.arrowIPCAll(sql, ...params, callback) ⇒ void](#connectionarrowipcallsql-params-callback--void)
    - [connection.arrowIPCStream(sql, ...params, callback) ⇒](#connectionarrowipcstreamsql-params-callback-)
    - [connection.each(sql, ...params, callback) ⇒ void](#connectioneachsql-params-callback--void)
    - [connection.stream(sql, ...params)](#connectionstreamsql-params)
    - [connection.register\_udf(name, return\_type, fun) ⇒ void](#connectionregister_udfname-return_type-fun--void)
    - [connection.prepare(sql, ...params, callback) ⇒ Statement](#connectionpreparesql-params-callback--statement)
    - [connection.exec(sql, ...params, callback) ⇒ void](#connectionexecsql-params-callback--void)
    - [connection.register\_udf\_bulk(name, return\_type, callback) ⇒ void](#connectionregister_udf_bulkname-return_type-callback--void)
    - [connection.unregister\_udf(name, return\_type, callback) ⇒ void](#connectionunregister_udfname-return_type-callback--void)
    - [connection.register\_buffer(name, array, force, callback) ⇒ void](#connectionregister_buffername-array-force-callback--void)
    - [connection.unregister\_buffer(name, callback) ⇒ void](#connectionunregister_buffername-callback--void)
  - [duckdb~Statement](#duckdbstatement)
    - [statement.sql ⇒](#statementsql-)
    - [statement.get()](#statementget)
    - [statement.run(sql, ...params, callback) ⇒ void](#statementrunsql-params-callback--void)
    - [statement.all(sql, ...params, callback) ⇒ void](#statementallsql-params-callback--void)
    - [statement.arrowIPCAll(sql, ...params, callback) ⇒ void](#statementarrowipcallsql-params-callback--void)
    - [statement.each(sql, ...params, callback) ⇒ void](#statementeachsql-params-callback--void)
    - [statement.finalize(sql, ...params, callback) ⇒ void](#statementfinalizesql-params-callback--void)
    - [statement.stream(sql, ...params)](#statementstreamsql-params)
    - [statement.columns() ⇒ Array.\<ColumnInfo\>](#statementcolumns--arraycolumninfo)
  - [duckdb~QueryResult](#duckdbqueryresult)
    - [queryResult.nextChunk() ⇒](#queryresultnextchunk-)
    - [queryResult.nextIpcBuffer() ⇒](#queryresultnextipcbuffer-)
    - [queryResult.asyncIterator()](#queryresultasynciterator)
  - [duckdb~Database](#duckdbdatabase)
    - [database.close(callback) ⇒ void](#databaseclosecallback--void)
    - [database.close\_internal(callback) ⇒ void](#databaseclose_internalcallback--void)
    - [database.wait(callback) ⇒ void](#databasewaitcallback--void)
    - [database.serialize(callback) ⇒ void](#databaseserializecallback--void)
    - [database.parallelize(callback) ⇒ void](#databaseparallelizecallback--void)
    - [database.connect(path) ⇒ Connection](#databaseconnectpath--connection)
    - [database.interrupt(callback) ⇒ void](#databaseinterruptcallback--void)
    - [database.prepare(sql) ⇒ Statement](#databasepreparesql--statement)
    - [database.run(sql, ...params, callback) ⇒ void](#databaserunsql-params-callback--void)
    - [database.scanArrowIpc(sql, ...params, callback) ⇒ void](#databasescanarrowipcsql-params-callback--void)
    - [database.each(sql, ...params, callback) ⇒ void](#databaseeachsql-params-callback--void)
    - [database.all(sql, ...params, callback) ⇒ void](#databaseallsql-params-callback--void)
    - [database.arrowIPCAll(sql, ...params, callback) ⇒ void](#databasearrowipcallsql-params-callback--void)
    - [database.arrowIPCStream(sql, ...params, callback) ⇒ void](#databasearrowipcstreamsql-params-callback--void)
    - [database.exec(sql, ...params, callback) ⇒ void](#databaseexecsql-params-callback--void)
    - [database.register\_udf(name, return\_type, fun) ⇒ this](#databaseregister_udfname-return_type-fun--this)
    - [database.register\_buffer(name) ⇒ this](#databaseregister_buffername--this)
    - [database.unregister\_buffer(name) ⇒ this](#databaseunregister_buffername--this)
    - [database.unregister\_udf(name) ⇒ this](#databaseunregister_udfname--this)
    - [database.registerReplacementScan(fun) ⇒ this](#databaseregisterreplacementscanfun--this)
    - [database.get()](#databaseget)
  - [duckdb~ERROR : number](#duckdberror--number)
  - [duckdb~OPEN\_READONLY : number](#duckdbopen_readonly--number)
  - [duckdb~OPEN\_READWRITE : number](#duckdbopen_readwrite--number)
  - [duckdb~OPEN\_CREATE : number](#duckdbopen_create--number)
  - [duckdb~OPEN\_FULLMUTEX : number](#duckdbopen_fullmutex--number)
  - [duckdb~OPEN\_SHAREDCACHE : number](#duckdbopen_sharedcache--number)
  - [duckdb~OPEN\_PRIVATECACHE : number](#duckdbopen_privatecache--number)
- [ColumnInfo : object](#columninfo--object)
- [TypeInfo : object](#typeinfo--object)
- [DuckDbError : object](#duckdberror--object)
- [HTTPError : object](#httperror--object)
