...
This package provides a Node.js API for [DuckDB](https://github.com/duckdb/duckdb). The API for this client is somewhat compliant to the SQLite Node.js client for easier transition.
