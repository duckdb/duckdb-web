...
<div class="box-link-wrapper">
    ...
    <div class="box-link third-width">
        <a href="{% link docs/preview/quack/overview.md %}"></a>
...
<div class="box-link-wrapper">
    ...
    <div class="box-link third-width">
        <a href="{% link docs/preview/clients/go/overview.md %}"></a>
        <span class="symbol"><img src="{% link images/icons/go.svg %}"></span>
        <span>Go</span>
        <svg class="chevron"><use href="#chevron-right"></use></svg>
    </div>
    <div class="box-link third-width">
        <a href="{% link docs/preview/clients/java/overview.md %}"></a>
    ...
    <div class="box-link third-width">
        <a href="{% link docs/preview/clients/rust/overview.md %}"></a>
