...
1. For systems which are supported by a DuckDB scanner extension, it's preferable to use the scanner. DuckDB currently offers scanners for [MySQL]({% link docs/preview/guides/database_integration/mysql.md %}), [PostgreSQL]({% link docs/preview/guides/database_integration/postgres.md %}) and [SQLite]({% link docs/preview/guides/database_integration/sqlite.md %}), as well as a generic [ODBC scanner]({% link docs/preview/core_extensions/odbc/overview.md %}).
