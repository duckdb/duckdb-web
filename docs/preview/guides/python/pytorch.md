...
To learn more about querying Arrow objects directly, see the [“SQL on Apache Arrow” guide]({% link docs/preview/guides/python/sql_on_arrow.md %}) and the [“Export to Apache Arrow” guide]({% link docs/preview/guides/python/export_arrow.md %}).
