...
results = con.execute("SELECT * FROM my_arrow_table WHERE i = 2").arrow_table()
```
...
results = con.execute("SELECT * FROM my_arrow_dataset WHERE i = 2").arrow_table()
```
...
results = con.execute("SELECT * FROM arrow_scanner").arrow_table()
```
...
results = con.execute("SELECT * FROM my_recordbatchreader WHERE i = 2").arrow_table()
```
