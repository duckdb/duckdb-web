...
To create a new table using the result from a query, use the [`CREATE TABLE ... AS SELECT` statement]({% link docs/preview/sql/statements/create_table.md %}#create-table--as-select-ctas):
