...
S3 Tables is an Iceberg REST Catalog. For the full list of `ATTACH` options — and details on the compatibility flags — see [Iceberg REST Catalogs]({% link docs/preview/core_extensions/iceberg/iceberg_rest_catalogs.md %}#attach-options).
