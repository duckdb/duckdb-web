...
| :--------------------------------------------------------------------- | :---------------------------------------------------------------------- | ----------- | :----------- | :---------------------- |
| [autocomplete]({% link docs/preview/core_extensions/autocomplete.md %}) | Adds support for autocomplete in the shell                              | Core team   | stable       |                         |
| [avro]({% link docs/preview/core_extensions/avro.md %})                 | Add support for reading Avro files                                      | Core team   | stable       |                         |
| [aws]({% link docs/preview/core_extensions/aws.md %})                   | Provides features that depend on the AWS SDK                            | Core team   | stable       |                         |
| [azure]({% link docs/preview/core_extensions/azure.md %})               | Adds a filesystem abstraction for Azure blob storage to DuckDB          | Core team   | stable       |                         |
| [delta]({% link docs/preview/core_extensions/delta.md %})               | Adds support for Delta Lake                                             | Core team   | experimental |                         |
| [ducklake]({% link docs/preview/core_extensions/ducklake.md %})         | Adds support for DuckLake                                               | Core team   | experimental |                         |
| [encodings]({% link docs/preview/core_extensions/encodings.md %})       | Adds support for encodings available in the ICU data repository         | Core team   | experimental |                         |
| [excel]({% link docs/preview/core_extensions/excel.md %})               | Adds support for reading and writing Excel files                        | Core team   | experimental |                         |
| [fts]({% link docs/preview/core_extensions/full_text_search.md %})      | Adds support for full-text search indexes                               | Core team   | experimental |                         |
| [httpfs]({% link docs/preview/core_extensions/httpfs/overview.md %})    | Adds support for reading/writing files over an HTTP(S) or S3 connection | Core team   | stable       | http, https, s3         |
| [iceberg]({% link docs/preview/core_extensions/iceberg/overview.md %})  | Adds support for Apache Iceberg                                         | Core team   | experimental |                         |
| [icu]({% link docs/preview/core_extensions/icu.md %})                   | Adds support for time zones and collations using the ICU library        | Core team   | stable       |                         |
...
| [spatial]({% link docs/preview/core_extensions/spatial/overview.md %})  | Adds support for working with geospatial data and functions             | Core team   | experimental |                         |
