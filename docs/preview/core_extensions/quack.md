...
The `quack` extension adds support for the [Quack remote protocol]({% link docs/preview/quack/overview.md %}).

## Usage

Quack is currently in a beta state. Quack will be transparently autoinstalled and [autoloaded]({% link docs/preview/extensions/overview.md %}#autoloading-extension) on first use.
