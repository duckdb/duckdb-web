...
> Warning Note that the TPC-H databases generated by the `tpch` extension have small differences from the official TPC-H specification.
> To obtain fully TPC-compliant datasets, use the [`tpchgen-cli` project](https://pypi.org/project/tpchgen-cli/).
