...
The [`spatial` extension]({% link docs/preview/core_extensions/spatial/overview.md %}) provides support for spatial indexing through the R-tree extension index type.
