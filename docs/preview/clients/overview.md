...
| [Go]({% link docs/preview/clients/go.md %})                                     | [Marc Boeker](https://github.com/duckdb) and the DuckDB team                        | Primary      | [{{ site.current_duckdb_go_version }}](https://github.com/duckdb/duckdb-go?tab=readme-ov-file#go-sql-driver-for-duckdb) |
