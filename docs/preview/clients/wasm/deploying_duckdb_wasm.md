...
Please review the [Extension Distribution page]({% link docs/preview/extensions/extension_distribution.md %}) for general information about extensions.
...
* [Instantiate]({% link docs/preview/clients/wasm/instantiation.md %}) — how the library, worker, and WebAssembly components served here are wired together at runtime.
* [Load Extensions]({% link docs/preview/clients/wasm/extensions.md %}) — how extensions are fetched, signed, and served from a custom repository.
* [Extension Distribution]({% link docs/preview/extensions/extension_distribution.md %}) — general information about extension repositories and creating a custom one.
* [DuckDB Wasm Client]({% link docs/preview/clients/wasm/overview.md %}) — the layered API and example deployments this page builds on.
* [Troubleshoot]({% link docs/preview/clients/wasm/troubleshoot.md %}) — cross-origin isolation for threading and other deployment-related issues.
