...
For platform-specific details, see the pages for [Linux]({% link docs/preview/clients/odbc/linux.md %}), [macOS]({% link docs/preview/clients/odbc/macos.md %}), and [Windows]({% link docs/preview/clients/odbc/windows.md %}).
