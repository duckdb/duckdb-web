...
The CLI supports [autocompletion]({% link docs/preview/clients/cli/autocomplete.md %}), and has sophisticated [editor features]({% link docs/preview/clients/cli/editing.md %}) and [syntax highlighting]({% link docs/preview/clients/cli/syntax_highlighting.md %}) on macOS, Linux and Windows.
