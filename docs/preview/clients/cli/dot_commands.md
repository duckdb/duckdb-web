...
| Command                                                               | Description                                                                                                                                                                      |
| --------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `.about`{:.language-sql .highlight}                                   | Prints version, description and license information about DuckDB.                                                                                                                |
...
| `.dump ⟨TABLE⟩`{:.language-sql .highlight}                            | Render database content as SQL. `TABLE` is a [`LIKE` pattern]({% link docs/preview/sql/functions/pattern_matching.md %}) for the tables to dump                                  |
...
| `.highlight_colors ⟨COMPONENT⟩ ⟨COLOR⟩`{:.language-sql .highlight}    | Configure the color of each query and result component. See the [Syntax Highlighting page]({% link docs/preview/clients/cli/syntax_highlighting.md %}) for details               |
| `.highlight_mode ⟨mixed/dark/light⟩`{:.language-sql .highlight}       | Toggle the highlight mode. See the [dark/light mode section]({% link docs/preview/clients/cli/friendly_cli.md %}#darklight-mode) for details                                     |
...
| `.pager ⟨OPTIONS⟩`{:.language-sql .highlight}                         | Control pager usage for output. See the [paging section]({% link docs/preview/clients/cli/output_formats.md %}#paging) for details                                               |
...
| `.tables ⟨TABLE⟩`{:.language-sql .highlight}                          | List tables [matching `LIKE` pattern]({% link docs/preview/sql/functions/pattern_matching.md %}) `TABLE` with column names, types and row counts, grouped by database and schema |
...
An optional `TABLE` argument filters the output using a [`LIKE` pattern]({% link docs/preview/sql/functions/pattern_matching.md %}#like). Multiple patterns can be provided as additional arguments.
...
See the [Syntax Highlighting page]({% link docs/preview/clients/cli/syntax_highlighting.md %}) for the list of components and colors.
