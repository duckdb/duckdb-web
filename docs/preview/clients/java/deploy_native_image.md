...
* [Troubleshoot]({% link docs/preview/clients/java/troubleshoot.md %}) — the Native Image errors that indicate missing metadata or a missing shared library.
* [Define Connections]({% link docs/preview/clients/java/connecting.md %}) — driver registration and connection configuration.
* [Java (JDBC) Client]({% link docs/preview/clients/java/overview.md %}) — installing the driver from Maven Central.
