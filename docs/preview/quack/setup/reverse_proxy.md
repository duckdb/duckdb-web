...
The Quack server speaks plain HTTP only and binds to localhost by default. See [Security]({% link docs/preview/quack/security.md %}) for the rationale behind these configurations.
