...
This page lists every function, setting, and log type exposed by the [quack extension]({% link docs/preview/core_extensions/quack.md %}).
For a tour of the protocol, start with the [Overview]({% link docs/preview/quack/overview.md %}).
...
You can plug in your own auth by creating any scalar function with the expected signature and pointing the setting at it. See [Security]({% link docs/preview/quack/security.md %}) for examples.
