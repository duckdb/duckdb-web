...
In order to enforce this property efficiently, an [ART index is automatically created]({% link docs/preview/sql/indexes.md %}) for every primary key or unique constraint that is defined in the table.
...
In order to enforce this property efficiently, an [ART index is automatically created]({% link docs/preview/sql/indexes.md %}) for every foreign key constraint that is defined in the table.
