...
See [Logical Operators]({% link docs/preview/sql/expressions/logical_operators.md %}) and [Comparison Operators]({% link docs/preview/sql/expressions/comparison_operators.md %}).