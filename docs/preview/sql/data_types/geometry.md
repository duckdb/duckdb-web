...
You can list all available CRSs known to DuckDB using the [`duckdb_coordinate_systems()`]({% link docs/preview/sql/meta/duckdb_table_functions.md %}#duckdb_coordinate_systems) function:
