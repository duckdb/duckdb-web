...
| `UUID`                     |                                    | [UUID data type]({% link docs/preview/sql/data_types/numeric.md %}#universally-unique-identifiers-uuids)   |
...
| [`VARIANT`]({% link docs/preview/sql/data_types/variant.md %}) | A semi-structured type where each value is self-contained with its own type information.                                                                                                        | Each row may hold a value of a different type.                                                                 | `42::VARIANT`             | `VARIANT`                          |
