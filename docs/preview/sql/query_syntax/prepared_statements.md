...
positional (`$1`),
and named (`$param`).
Note that not all clients support all of these syntaxes, e.g., the [JDBC client]({% link docs/preview/clients/java/querying.md %}) only supports auto-incremented parameters in prepared statements.
