...
The `SWITCH` expression is syntactic sugar for the `CASE` expression. It takes an expression, a [`MAP`]({% link docs/preview/sql/data_types/map.md %}) of values to results, and an optional default value.
