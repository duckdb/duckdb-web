...
Casting between numeric types might have rounding implications. The applicable rounding rules can be found on the [`NUMERIC type page`]({% link docs/preview/sql/data_types/numeric.md %}#rounding).
