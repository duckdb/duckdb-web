...
`TRY` cannot be used in combination with a volatile function, an aggregate function, or a [scalar subquery]({% link docs/preview/sql/expressions/subqueries.md %}#scalar-subquery).
For example:
