...
With the [command line client]({% link docs/preview/clients/cli/overview.md %}), you can use the `-storage-version` argument:
...
The `storage_compatibility_version` [configuration option]({% link docs/preview/configuration/overview.md %}#configuration-reference) can also be used to specify the storage version to use. It can be specified in various ways.
