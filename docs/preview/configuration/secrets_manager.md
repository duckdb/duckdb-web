...
| `iceberg`     | Iceberg REST Catalog | [`httpfs`]({% link docs/preview/core_extensions/httpfs/s3api.md %}), [`iceberg`]({% link docs/preview/core_extensions/iceberg/catalogs.md %}) |
| `mysql`       | MySQL                | [`mysql`]({% link docs/preview/core_extensions/mysql.md %})                       |
| `postgres`    | PostgreSQL           | [`postgres`]({% link docs/preview/core_extensions/postgres/overview.md %})                 |
| `quack`       | Quack                | [`quack`]({% link docs/preview/core_extensions/quack.md %})                       |
