...
| [`profiling_mode`]({% link docs/preview/configuration/pragmas.md %}#profiling_mode)                                                                                                | Toggle additional optimizer and planner metrics | `standard`                                               | `standard`, `detailed`, `all`                                                                                                                                       |
| [`configure_profiling`]({% link docs/preview/configuration/pragmas.md %}#custom_profiling_metrics)                                                                                 | Enable or disable specific metrics              | All metrics except those activated by detailed profiling | A JSON object that matches the following: `{"METRIC_NAME": "boolean", ...}`. ([List of all available metrics]({% link docs/preview/dev/metrics.md %}#all_metrics)) |
...
DuckDB supports a wide range of metrics that can be enabled or disabled independently. To learn more and to see the full list of available metrics, refer to the [metrics documentation]({% link docs/preview/dev/metrics.md %}#all_metrics).
...
These include all the metrics in the [Phase timing]({% link docs/preview/dev/metrics.md %}#phase_timing_metrics) metric group.
