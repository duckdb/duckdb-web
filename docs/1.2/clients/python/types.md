...
layout: docu
redirect_from:
- /docs/1.2/api/python/types
- /docs/1.2/api/python/types/
- /docs/1.2/clients/python/types
title: Types API
---

The `DuckDBPyType` class represents a type instance of our [data types]({% link docs/1.2/sql/data_types/overview.md %}).
