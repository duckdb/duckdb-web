...
layout: docu
redirect_from:
- /docs/1.2/api/python/known_issues
- /docs/1.2/api/python/known_issues/
- /docs/1.2/clients/python/known_issues
...
In Python, the output of the [`EXPLAIN` statement]({% link docs/1.2/guides/meta/explain.md %}) contains hard line breaks (`\n`):
...
Please also check out the [Jupyter guide]({% link docs/1.2/guides/python/jupyter.md %}) for tips on using Jupyter with JupySQL.
