...
layout: docu
redirect_from:
- /docs/1.2/api/cli/syntax_highlighting
- /docs/1.2/api/cli/syntax_highlighting/
- /docs/1.2/clients/cli/syntax_highlighting
...
There are several components of a query that are highlighted in different colors. The colors can be configured using [dot commands]({% link docs/1.2/clients/cli/dot_commands.md %}).
