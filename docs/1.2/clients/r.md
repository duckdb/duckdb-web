...
Also refer to the [data import documentation]({% link docs/1.2/data/overview.md %}) for more options of efficiently importing data.
...
You can use the [`memory_limit` configuration option]({% link docs/1.2/configuration/pragmas.md %}) to limit the memory use of DuckDB, e.g.:
