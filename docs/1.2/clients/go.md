...
The DuckDB Go client supports the [DuckDB Appender API]({% link docs/1.2/data/appender.md %}) for bulk inserts. You can obtain a new Appender by supplying a DuckDB connection to `NewAppenderFromConn()`. For example:
