...
layout: docu
redirect_from:
- /docs/1.2/api/odbc/configuration
- /docs/1.2/api/odbc/configuration/
- /docs/1.2/clients/odbc/configuration
...
For platform-specific details, see the pages for [Linux]({% link docs/1.2/clients/odbc/linux.md %}), [macOS]({% link docs/1.2/clients/odbc/macos.md %}), and [Windows]({% link docs/1.2/clients/odbc/windows.md %}).
