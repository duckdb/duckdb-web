...
Note how we pass the table name as the first argument to [`min_by`]({% link docs/1.2/sql/functions/aggregates.md %}#min_byarg-val-n) to return a struct containing the entire matched row.
