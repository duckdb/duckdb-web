...
layout: docu
redirect_from:
- /docs/1.2/guides/snippets/copy_in-memory_database_to_file
...
To achieve this, **attach to a new disk-based database** and use the [`COPY FROM DATABASE ... TO` command]({% link docs/1.2/sql/statements/copy.md %}#copy-from-database--to):
