...
layout: docu
redirect_from:
- /docs/1.2/guides/import/query_postgres
- /docs/1.2/guides/import/query_postgres/
- /docs/1.2/guides/database_integration/postgres
title: PostgreSQL Import
---

To run a query directly on a running PostgreSQL database, the [`postgres` extension]({% link docs/1.2/extensions/postgres.md %}) is required.
...
For more information see the [PostgreSQL extension documentation]({% link docs/1.2/extensions/postgres.md %}).
