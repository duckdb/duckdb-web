...
redirect_from:
- /docs/1.2/test/functions/overview
- /docs/1.2/test/functions/overview/
- /docs/1.2/sql/functions/overview
title: Functions
---
...
DuckDB supports the dot syntax for function chaining. This allows the function call `fn(arg1, arg2, arg3, ...)` to be rewritten as `arg1.fn(arg2, arg3, ...)`. For example, take the following use of the [`replace` function]({% link docs/1.2/sql/functions/char.md %}#replacestring-source-target):
