...
layout: docu
redirect_from:
- /docs/1.2/test/functions/math
- /docs/1.2/test/functions/math/
- /docs/1.2/sql/functions/numeric
...
The table below shows the available mathematical operators for [numeric types]({% link docs/1.2/sql/data_types/numeric.md %}).
