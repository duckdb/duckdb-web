...
This section describes functions and operators for examining and manipulating [`DATE`]({% link docs/1.2/sql/data_types/date.md %}) values.
...
Adding to or subtracting from [infinite values]({% link docs/1.2/sql/data_types/date.md %}#special-values) produces the same infinite value.

## Date Functions

The table below shows the available functions for `DATE` types.
Dates can also be manipulated with the [timestamp functions]({% link docs/1.2/sql/functions/timestamp.md %}) through type promotion.
...
| [`date_diff(part, startdate, enddate)`](#date_diffpart-startdate-enddate) | The number of [partition]({% link docs/1.2/sql/functions/datepart.md %}) boundaries between the dates. |
| [`date_part(part, date)`](#date_partpart-date) | Get the [subfield]({% link docs/1.2/sql/functions/datepart.md %}) (equivalent to `extract`). |
| [`date_sub(part, startdate, enddate)`](#date_subpart-startdate-enddate) | The number of complete [partitions]({% link docs/1.2/sql/functions/datepart.md %}) between the dates. |
| [`date_trunc(part, date)`](#date_truncpart-date) | Truncate to specified [precision]({% link docs/1.2/sql/functions/datepart.md %}). |
| [`datediff(part, startdate, enddate)`](#datediffpart-startdate-enddate) | The number of [partition]({% link docs/1.2/sql/functions/datepart.md %}) boundaries between the dates. Alias of `date_diff`. |
| [`datepart(part, date)`](#datepartpart-date) | Get the [subfield]({% link docs/1.2/sql/functions/datepart.md %}) (equivalent to `extract`). Alias of `date_part`. |
| [`datesub(part, startdate, enddate)`](#datesubpart-startdate-enddate) | The number of complete [partitions]({% link docs/1.2/sql/functions/datepart.md %}) between the dates. Alias of `date_sub`. |
| [`datetrunc(part, date)`](#datetruncpart-date) | Truncate to specified [precision]({% link docs/1.2/sql/functions/datepart.md %}). Alias of `date_trunc`. |
| [`dayname(date)`](#daynamedate) | The (English) name of the weekday. |
| [`extract(part from date)`](#extractpart-from-date) | Get [subfield]({% link docs/1.2/sql/functions/datepart.md %}) from a date. |
...
| [`strftime(date, format)`](#strftimedate-format) | Converts a date to a string according to the [format string]({% link docs/1.2/sql/functions/dateformat.md %}). |
...
| **Description** | The number of [partition]({% link docs/1.2/sql/functions/datepart.md %}) boundaries between the dates. |
...
| **Description** | Get the [subfield]({% link docs/1.2/sql/functions/datepart.md %}) (equivalent to `extract`). |
...
| **Description** | The number of complete [partitions]({% link docs/1.2/sql/functions/datepart.md %}) between the dates. |
...
| **Description** | Get [subfield]({% link docs/1.2/sql/functions/datepart.md %}) from a date. |
...
| **Description** | Converts a date to a string according to the [format string]({% link docs/1.2/sql/functions/dateformat.md %}). |
...
There are also dedicated extraction functions to get the [subfields]({% link docs/1.2/sql/functions/datepart.md %}#part-functions).
