...
DuckDB offers [pattern matching operators]({% link docs/1.2/sql/functions/pattern_matching.md %})
([`LIKE`]({% link docs/1.2/sql/functions/pattern_matching.md %}#like),
[`SIMILAR TO`]({% link docs/1.2/sql/functions/pattern_matching.md %}#similar-to),
[`GLOB`]({% link docs/1.2/sql/functions/pattern_matching.md %}#glob)),
