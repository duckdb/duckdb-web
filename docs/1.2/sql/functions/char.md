...
This section describes functions and operators for examining and manipulating [`STRING` values]({% link docs/1.2/sql/data_types/text.md %}).
...
| [`string[begin:end]`](#stringbeginend) | Extract a string using slice conventions, see [slicing]({% link docs/1.2/sql/functions/list.md %}#slicing). |
| [`string LIKE target`](#string-like-target) | Returns true if the `string` matches the like specifier (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %})). |
| [`string SIMILAR TO regex`](#string-similar-to-regex) | Returns `true` if the `string` matches the `regex`; identical to `regexp_full_match` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %})). |
...
| [`greatest(x1, x2, ...)`](#greatestx1-x2-) | Selects the largest value using lexicographical ordering. Note that lowercase characters are considered “larger” than uppercase characters and [collations]({% link docs/1.2/sql/expressions/collations.md %}) are not supported. |
| [`hash(value)`](#hashvalue) | Returns a `UBIGINT` with the hash of the `value`. |
| [`ilike_escape(string, like_specifier, escape_character)`](#ilike_escapestring-like_specifier-escape_character) | Returns true if the `string` matches the `like_specifier` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %})) using case-insensitive matching. `escape_character` is used to search for wildcard characters in the `string`. |
...
| [`least(x1, x2, ...)`](#leastx1-x2-) | Selects the smallest value using lexicographical ordering. Note that uppercase characters are considered “smaller” than lowercase characters, and [collations]({% link docs/1.2/sql/expressions/collations.md %}) are not supported. |
...
| [`regexp_extract(string, pattern[, group = 0])`](#regexp_extractstring-pattern-group--0) | If `string` contains the regexp `pattern`, returns the capturing group specified by optional parameter `group` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %}#using-regexp_extract)). |
| [`regexp_extract(string, pattern, name_list)`](#regexp_extractstring-pattern-name_list) | If `string` contains the regexp `pattern`, returns the capturing groups as a struct with corresponding names from `name_list` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %}#using-regexp_extract)). |
...
| [`regexp_full_match(string, regex)`](#regexp_full_matchstring-regex) | Returns `true` if the entire `string` matches the `regex` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %})). |
| [`regexp_matches(string, pattern)`](#regexp_matchesstring-pattern) | Returns `true` if  `string` contains the regexp `pattern`, `false` otherwise (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %}#using-regexp_matches)). |
| [`regexp_replace(string, pattern, replacement)`](#regexp_replacestring-pattern-replacement) | If `string` contains the regexp `pattern`, replaces the matching part with `replacement` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %}#using-regexp_replace)). |
...
| **Description** | Returns true if the `string` matches the like specifier (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %})). |
...
| **Description** | Returns `true` if the `string` matches the `regex`; identical to `regexp_full_match` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %})) |
...
| **Description** | Selects the largest value using lexicographical ordering. Note that lowercase characters are considered “larger” than uppercase characters and [collations]({% link docs/1.2/sql/expressions/collations.md %}) are not supported. |
...
| **Description** | Returns true if the `string` matches the `like_specifier` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %})) using case-insensitive matching. `escape_character` is used to search for wildcard characters in the `string`. |
...
| **Description** | Selects the smallest value using lexicographical ordering. Note that uppercase characters are considered “smaller” than lowercase characters, and [collations]({% link docs/1.2/sql/expressions/collations.md %}) are not supported. |
...
| **Description** | Returns true if the `string` matches the `like_specifier` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %})) using case-sensitive matching. `escape_character` is used to search for wildcard characters in the `string`. |
...
| **Description** | Returns false if the `string` matches the `like_specifier` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %})) using case-sensitive matching. `escape_character` is used to search for wildcard characters in the `string`. |
...
| **Description** | Returns false if the `string` matches the `like_specifier` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %})) using case-insensitive matching. `escape_character` is used to search for wildcard characters in the `string`. |
...
| **Description** | If `string` contains the regexp `pattern`, returns the capturing group specified by optional parameter `group` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %}#using-regexp_extract)). |
...
| **Description** | If `string` contains the regexp `pattern`, returns the capturing groups as a struct with corresponding names from `name_list` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %}#using-regexp_extract)). |
...
| **Description** | Returns `true` if the entire `string` matches the `regex` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %})). |
...
| **Description** | Returns `true` if  `string` contains the regexp `pattern`, `false` otherwise (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %}#using-regexp_matches)). |
...
| **Description** | If `string` contains the regexp `pattern`, replaces the matching part with `replacement` (see [Pattern Matching]({% link docs/1.2/sql/functions/pattern_matching.md %}#using-regexp_replace)). |
