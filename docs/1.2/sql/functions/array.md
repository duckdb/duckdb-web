...
layout: docu
redirect_from:
- /docs/1.2/sql/functions/array
title: Array Functions
---

<!-- markdownlint-disable MD001 -->

All [`LIST` functions]({% link docs/1.2/sql/functions/list.md %}) work with the [`ARRAY` data type]({% link docs/1.2/sql/data_types/array.md %}). Additionally, several `ARRAY`-native functions are also supported.
