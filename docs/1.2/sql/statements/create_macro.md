...
redirect_from:
- /docs/1.2/sql/statements/create_macro
...
To define macros on arbitrary tables, use the [`query_table` function]({% link docs/1.2/guides/sql_features/query_and_query_table_functions.md %}). For example, the following macro computes a column-wise checksum on a table:
