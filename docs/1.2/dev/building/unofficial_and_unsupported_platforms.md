...
layout: docu
redirect_from:
- /docs/1.2/dev/building/unofficial_and_unsupported_platforms
...
DuckDB is built and distributed for several platform with [different levels of support]({% link docs/1.2/dev/building/overview.md %}).
...
For example, see the build instructions for [32-bit Raspberry Pi boards]({% link docs/1.2/dev/building/raspberry_pi.md %}#raspberry-pi-32-bit).
