...
layout: docu
redirect_from:
- /docs/1.2/operations_manual/non-deterministic_behavior
...
2. Enforce ordering. For example, you can use the [`ORDER BY ALL` clause]({% link docs/1.2/sql/query_syntax/orderby.md %}#order-by-all):
   ...
   You can also sort lists using [`list_sort`]({% link docs/1.2/sql/functions/list.md %}#list_sortlist):
