...
layout: docu
redirect_from:
- /docs/1.2/data/csv/auto_detection
...
The set of candidate types that should be considered by the CSV reader can be explicitly specified using the [`auto_type_candidates`]({% link docs/1.2/data/csv/overview.md %}#auto_type_candidates-details) option.
