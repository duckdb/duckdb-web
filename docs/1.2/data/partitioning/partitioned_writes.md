...
layout: docu
redirect_from:
- /docs/1.2/data/partitioning/partitioned_writes
...
To handle slashes in column names, use Percent-Encoding implemented by the [`url_encode` function]({% link docs/1.2/sql/functions/char.md %}#url_encodestring).
