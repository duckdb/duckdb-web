...
layout: docu
redirect_from:
- /docs/1.2/data/csv/multiple_files
- /docs/1.2/data/csv/multiple_files/
- /docs/1.2/data/multiple_files/overview
...
See the [combining schemas]({% link docs/1.2/data/multiple_files/combining_schemas.md %}) page for tips on reading files with different schemas.
