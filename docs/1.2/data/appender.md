...
In the [C++ API]({% link docs/1.2/clients/cpp.md %}), the Appender works as follows:
...
You can change this by explicitly using [transactions]({% link docs/1.2/sql/statements/transactions.md %}) and surrounding your batches of `AppendRow` calls by `BEGIN TRANSACTION` and `COMMIT` statements.
...
* [C]({% link docs/1.2/clients/c/appender.md %})
* [Go]({% link docs/1.2/clients/go.md %}#appender)
* [Java (JDBC)]({% link docs/1.2/clients/java.md %}#appender)
* [Julia]({% link docs/1.2/clients/julia.md %}#appender-api)
* [Rust]({% link docs/1.2/clients/rust.md %}#appender)
