...
To write a Parquet file to S3, the [`httpfs` extension](../../extensions/httpfs/overview) is required. This can be installed use the `INSTALL` SQL command. This only needs to be run once.
