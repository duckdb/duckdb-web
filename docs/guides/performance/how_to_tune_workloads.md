...
DuckDB parallelizes the workload based on _[row groups](/docs/internals/storage#row-groups),_ i.e., groups of rows that are stored together at the storage level.
