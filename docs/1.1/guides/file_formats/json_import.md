...
For additional options, see the [JSON Loading reference]({% link docs/1.1/data/json/overview.md %}) and the [`COPY` statement documentation]({% link docs/1.1/sql/statements/copy.md %}).