...
Please see the [installation page]({% link docs/1.1/installation/index.html %}?environment=r) for details.
...
Also refer to the [data import documentation]({% link docs/1.1/data/overview.md %}) for more options of efficiently importing data.
...
You can use the [`memory_limit` configuration option]({% link docs/1.1/configuration/pragmas.md %}) to limit the memory use of DuckDB, e.g.:
