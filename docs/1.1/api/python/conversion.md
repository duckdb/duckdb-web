...
This is a mapping of Python object types to DuckDB [Logical Types]({% link docs/1.1/sql/data_types/overview.md %}):
...
Below are some examples using this functionality. See the [Python guides]({% link docs/1.1/guides/overview.md %}#python-client) for more examples.
