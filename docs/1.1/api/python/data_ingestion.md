...
See the [CSV Import]({% link docs/1.1/data/csv/overview.md %}) page for more information.
...
Read a Parquet file over [https]({% link docs/1.1/extensions/httpfs/overview.md %}):
...
See the [Parquet Loading]({% link docs/1.1/data/parquet/overview.md %}) page for more information.
...
These types include the following: Pandas DataFrame, Polars DataFrame, Polars LazyFrame, NumPy arrays, [relations]({% link docs/1.1/api/python/relational_api.md %}), and Arrow objects.

Only variables that are visible to Python code at the location of the `sql()` or `execute()` call can be used in this manner.
Accessing these variables is made possible by [replacement scans]({% link docs/1.1/api/c/replacement_scans.md %}). To disable replacement scans entirely, use:

```sql
SET python_enable_replacements = false;
```

DuckDB supports querying multiple types of Apache Arrow objects including [tables](https://arrow.apache.org/docs/python/generated/pyarrow.Table.html), [datasets](https://arrow.apache.org/docs/python/generated/pyarrow.dataset.Dataset.html), [RecordBatchReaders](https://arrow.apache.org/docs/python/generated/pyarrow.ipc.RecordBatchStreamReader.html), and [scanners](https://arrow.apache.org/docs/python/generated/pyarrow.dataset.Scanner.html). See the Python [guides]({% link docs/1.1/guides/overview.md %}#python-client) for more examples.
...
You can register Python objects as DuckDB tables using the [`DuckDBPyConnection.register()` function]({% link docs/1.1/api/python/reference/index.md %}#duckdb.DuckDBPyConnection.register).
...
* [Replacement scans]({% link docs/1.1/api/c/replacement_scans.md %})