...
In Python, the output of the [`EXPLAIN` statement]({% link docs/1.1/guides/meta/explain.md %}) contains hard line breaks (`\n`):
...
Please also check out the [Jupyter guide]({% link docs/1.1/guides/python/jupyter.md %}) for tips on using Jupyter with JupySQL.
