...
[Autoloading]({% link docs/1.1/extensions/overview.md %}), i.e., the possibility for DuckDB to add extension functionality on-the-fly, is enabled by default in DuckDB-Wasm.

## List of Officially Available Extensions

| Extension name | Description | Aliases |
|---|-----|--|
| [autocomplete]({% link docs/1.1/extensions/autocomplete.md %}) | Adds support for autocomplete in the shell                       |                 |
| [excel]({% link docs/1.1/extensions/excel.md %})               | Adds support for Excel-like format strings                       |                 |
| [fts]({% link docs/1.1/extensions/full_text_search.md %})      | Adds support for Full-Text Search Indexes                        |                 |
| [icu]({% link docs/1.1/extensions/icu.md %})                   | Adds support for time zones and collations using the ICU library |                 |
| [inet]({% link docs/1.1/extensions/inet.md %})                 | Adds support for IP-related data types and functions             |                 |
| [json]({% link docs/1.1/data/json/overview.md %})              | Adds support for JSON operations                                 |                 |
| [parquet]({% link docs/1.1/data/parquet/overview.md %})        | Adds support for reading and writing Parquet files               |                 |
| [sqlite]({% link docs/1.1/extensions/sqlite.md %})             | Adds support for reading SQLite database files                   | sqlite, sqlite3 |
| [sqlsmith]({% link docs/1.1/extensions/sqlsmith.md %})         |                                                                  |                 |
| [substrait]({% link docs/1.1/extensions/substrait.md %})       | Adds support for the Substrait integration                       |                 |
| [tpcds]({% link docs/1.1/extensions/tpcds.md %})               | Adds TPC-DS data generation and query support                    |                 |
| [tpch]({% link docs/1.1/extensions/tpch.md %})                 | Adds TPC-H data generation and query support                     |                 |
