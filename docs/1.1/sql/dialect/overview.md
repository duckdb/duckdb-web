...
For example, interchangeability with data frame libraries necessitates [order preservation of inserts]({% link docs/1.1/sql/dialect/order_preservation.md %}) to be supported by default.
