...
This section describes functions and operators for examining and manipulating [`INTERVAL`]({% link docs/1.1/sql/data_types/interval.md %}) values.
...
| Name | Description |
|:--|:-------|
| [`date_part(part, interval)`](#date_partpart-interval) | Extract [datepart component]({% link docs/1.1/sql/functions/datepart.md %}) (equivalent to `extract`). See [`INTERVAL`]({% link docs/1.1/sql/data_types/interval.md %}) for the sometimes surprising rules governing this extraction. |
...
> Only the documented [date part components]({% link docs/1.1/sql/functions/datepart.md %}) are defined for intervals.

#### `date_part(part, interval)`

<div class="nostroke_table"></div>

| **Description** | Extract [datepart component]({% link docs/1.1/sql/functions/datepart.md %}) (equivalent to `extract`). See [`INTERVAL`]({% link docs/1.1/sql/data_types/interval.md %}) for the sometimes surprising rules governing this extraction. |
