...
See the [`STRUCT` data type]({% link docs/1.1/sql/data_types/struct.md %}) and [`STRUCT` functions]({% link docs/1.1/sql/functions/struct.md %}) pages for more details on working with structs.
