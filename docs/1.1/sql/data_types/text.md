...
* [string literals]({% link docs/1.1/sql/data_types/literal_types.md %}#string-literals)
* [casting]({% link docs/1.1/sql/expressions/cast.md %}#explicit-casting) expressions to a text type
* applying a [string operator]({% link docs/1.1/sql/functions/char.md %}#text-functions-and-operators), or invoking a function that returns a text type value

## Strings with Special Characters

To use special characters in string, use [escape string literals]({% link docs/1.1/sql/data_types/literal_types.md %}#escape-string-literals) or [dollar-quoted string literals]({% link docs/1.1/sql/data_types/literal_types.md %}#dollar-quoted-string-literals). Alternatively, you can use concatenation and the [`chr` character function]({% link docs/1.1/sql/functions/char.md %}):
...
See [Text Functions]({% link docs/1.1/sql/functions/char.md %}) and [Pattern Matching]({% link docs/1.1/sql/functions/pattern_matching.md %}).