...
2. Enforce ordering. For example, you can use the [`ORDER BY ALL` clause]({% link docs/1.1/sql/query_syntax/orderby.md %}#order-by-all):
   ...
   You can also sort lists using [`list_sort`]({% link docs/1.1/sql/functions/list.md %}#list_sortlist):
