...
As of DuckDB v1.1.0 the [`spatial` extension]({% link docs/1.1/extensions/spatial/overview.md %}) provides basic support for spatial indexing through the R-tree extension index type.
