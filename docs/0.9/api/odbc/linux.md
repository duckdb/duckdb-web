...
layout: docu
redirect_from:
- docs/archive/0.9.2/api/odbc/linux
- docs/archive/0.9.1/api/odbc/linux
- docs/archive/0.9.0/api/odbc/linux
...
DuckDB releases the ODBC driver as asset. For linux, download it from <a href="https://github.com/duckdb/duckdb/releases/download/v0.9.2/duckdb_odbc-linux-amd64.zip">ODBC Linux Asset</a> that contains the following artifacts:
