...
It is possible to describe remote tables via the [`httpfs` extension]({% link docs/1.0/extensions/httpfs/overview.md %}) using the `DESCRIBE TABLE` statement. For example:
