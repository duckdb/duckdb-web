...
Below is an example of running `EXPLAIN ANALYZE` on [`Q13`](https://github.com/duckdb/duckdb/blob/main/extension/tpch/dbgen/queries/q13.sql) of the [TPC-H benchmark]({% link docs/1.0/extensions/tpch.md %}) on the scale factor 1 data set.
...
For more information, see the [Profiling page]({% link docs/1.0/dev/profiling.md %}).