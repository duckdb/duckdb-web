...
The shell offers context-aware autocomplete of SQL queries through the [`autocomplete` extension]({% link docs/1.0/extensions/autocomplete.md %}). autocomplete is triggered by pressing `Tab`.
