...
See the [CSV Import]({% link docs/1.0/data/csv/overview.md %}) page for more information.
...
Read a Parquet file over [https]({% link docs/1.0/extensions/httpfs/overview.md %}):
...
See the [Parquet Loading]({% link docs/1.0/data/parquet/overview.md %}) page for more information.
...
These types include the following: Pandas DataFrame, Polars DataFrame, Polars LazyFrame, NumPy arrays, [relations]({% link docs/1.0/api/python/relational_api.md %}), and Arrow objects.
Accessing these is made possible by [replacement scans]({% link docs/1.0/api/c/replacement_scans.md %}).

DuckDB supports querying multiple types of Apache Arrow objects including [tables](https://arrow.apache.org/docs/python/generated/pyarrow.Table.html), [datasets](https://arrow.apache.org/docs/python/generated/pyarrow.dataset.Dataset.html), [RecordBatchReaders](https://arrow.apache.org/docs/python/generated/pyarrow.ipc.RecordBatchStreamReader.html), and [scanners](https://arrow.apache.org/docs/python/generated/pyarrow.dataset.Scanner.html). See the Python [guides]({% link docs/1.0/guides/overview.md %}#python-client) for more examples.
...
You can register Python objects as DuckDB tables using the [`DuckDBPyConnection.register()` function]({% link docs/1.0/api/python/reference/index.md %}#duckdb.DuckDBPyConnection.register).
...
* [Replacement scans]({% link docs/1.0/api/c/replacement_scans.md %})