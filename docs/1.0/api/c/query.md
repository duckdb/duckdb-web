...
See the [Types]({% link docs/1.0/api/c/types.md %}) page for more information.
...
accessed, see the comments in the [Types section]({% link docs/1.0/api/c/types.md %}) or the `DUCKDB_TYPE` enum.
