...
When this flag is set, the [Python]({% link docs/1.0/api/python/overview.md %}) package is built.

### `BUILD_SHELL`

When this flag is set, the [CLI]({% link docs/1.0/api/cli/overview.md %}) is built, this is usually enabled by default.
...
When this flag is set, the [Java]({% link docs/1.0/api/java.md %}) package is built.

### `BUILD_ODBC`

When this flag is set, the [ODBC]({% link docs/1.0/api/odbc/overview.md %}) package is built.
