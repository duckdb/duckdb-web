...
To see the differences between DuckDB and PostgreSQL, see the [PostgreSQL Compatibility page]({% link docs/1.0/sql/dialect/postgresql_compatibility.md %}).
...
To generate a new UUID, use the [`uuid()` utility function]({% link docs/1.0/sql/functions/utility.md %}#utility-functions).

## Functions

See [Numeric Functions and Operators]({% link docs/1.0/sql/functions/numeric.md %}).