...
All [`LIST` functions]({% link docs/1.0/sql/functions/nested.md %}#list-functions) work with the [`ARRAY` data type]({% link docs/1.0/sql/data_types/array.md %}). Additionally, several `ARRAY`-native functions are also supported.
