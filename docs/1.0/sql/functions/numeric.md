...
layout: docu
redirect_from:
- docs/archive/1.0/test/functions/math
...
The table below shows the available mathematical operators for [numeric types]({% link docs/1.0/sql/data_types/numeric.md %}).
