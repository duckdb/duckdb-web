...
| [`union_tag(union)`](#union_tagunion) | Retrieve the currently selected tag of the union as an [Enum]({% link docs/1.0/sql/data_types/enum.md %}). |
...
| **Description** | Retrieve the currently selected tag of the union as an [Enum]({% link docs/1.0/sql/data_types/enum.md %}). |
