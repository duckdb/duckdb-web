...
positional (`$1`),
and named (`$param`).
Note that not all clients support all of these syntaxes, e.g., the [JDBC client]({% link docs/1.0/api/java.md %}) only supports auto-incremented parameters in prepared statements.
