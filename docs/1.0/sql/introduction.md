...
In the examples that follow, we assume that you have installed the DuckDB Command Line Interface (CLI) shell. See the [installation page]({% link docs/1.0/installation/index.html %}?environment=cli) for information on how to install the CLI.
