...
The `tpch` extension is shipped by default in some DuckDB builds, otherwise it will be transparently  [autoloaded](/docs/extensions/overview#autoloading-extensions) on first use.
