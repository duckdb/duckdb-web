...
For building and installing extensions from source, see the [building guide](/docs/dev/building/build_instructions#building-and-installing-extensions-from-source).
