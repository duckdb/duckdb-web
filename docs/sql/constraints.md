...
> Constraints can have a strong effect on performance, slowing down loading/updates and speeding up certain queries. Please consult the [Performance Guide](../guides/performance/schema#constraints) for details.
