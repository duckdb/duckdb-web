...
| http_retries                             | HTTP retries on I/O error (default 3)                                                                                                                   | UBIGINT    |                 |
| http_retry_backoff                       | Backoff factor for exponentially increasing retry wait time (default 4)                                                                                 | FLOAT      |                 |
| http_retry_wait_ms                       | Time between retries (default 100ms)                                                                                                                    | UBIGINT    |                 |
| http_timeout                             | HTTP connection timeout (default 30000ms)                                                                                                               | UBIGINT    |                 |
