...
| `gen_random_uuid()` | Alias of `uuid`. Return a random uuid similar to this: eeccb8c5-4399-b2bb-bb5e-222f4e14b687. | `gen_random_uuid()` | various |
...
| `uuid()` | Return a random uuid similar to this: eeccb8c5-4399-b2bb-bb5e-222f4e14b687. | `uuid()` | various |
