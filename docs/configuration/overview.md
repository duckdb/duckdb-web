...
| `index_scan_max_count`                       | The maximum index scan count sets a fixed threshold for index scans.                                                                              | `UBIGINT` | `2048`                                              |
| `index_scan_percentage`                      | The index scan percentage sets a percental threshold for index scans.                                                                             | `DOUBLE`  | `0.001`                                             |
...
| Name                                 | Description                                                                                                                                             | Type      | Default value                                     |
|--------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|---------------------------------------------------|
| `custom_profiling_settings`          | Accepts a **JSON** enabling custom metrics                                                                                                              | `VARCHAR` | `{"OPERATOR_TIMING": "true", "CPU_TIME": "true"}` |
