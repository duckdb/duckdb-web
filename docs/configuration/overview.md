...
Configuration options come with different default [scopes](../sql/statements/set#scopes): `GLOBAL` and `LOCAL`. Below is a list of all available configuration options.
