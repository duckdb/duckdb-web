...
- Must be greater or equal to 16384 (16KB).
- Must be lesser or equal to 262144 (256KB).
...
It is also possible to set the block size on a per-file basis; see [`ATTACH`]({% link docs/sql/statements/attach.md %}).
