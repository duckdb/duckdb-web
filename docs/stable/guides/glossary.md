...
The platform is a combination of the operating system (e.g., Linux, macOS, Windows), system architecture (e.g., AMD64, ARM64), and, optionally, the compiler used (e.g., GCC4). Platforms are used to distribute DuckDB binaries and [extension packages]({% link docs/stable/extensions/extension_distribution.md %}#platforms).
