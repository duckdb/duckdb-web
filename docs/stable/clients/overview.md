...
| [Go]({% link docs/stable/clients/go.md %})                                     | The DuckDB team                                                                         | Primary      | [{{ site.current_duckdb_go_version }}](https://github.com/duckdb/duckdb-go?tab=readme-ov-file#go-sql-driver-for-duckdb)   |
