...
| [jemalloc]({% link docs/stable/core_extensions/jemalloc.md %})         |                                                                                    | Overwrites the system allocator with jemalloc                                      | stable       |                         |
...
| [vortex]({% link docs/stable/core_extensions/vortex.md %})             | [<span class="github">GitHub</span>](https://github.com/vortex-data/duckdb-vortex) | Adds support for reading and writing Vortex files                                  | experimental |                         |
