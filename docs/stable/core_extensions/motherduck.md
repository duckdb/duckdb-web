...
The `motherduck` extension will be transparently [autoinstalled and autoloaded]({% link docs/stable/core_extensions/overview.md %}#autoloading-extensions) on first use from the official extension repository.
