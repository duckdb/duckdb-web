...
author: Mark Raasveldt, Hannes Mühleisen, Gábor Szárnyas
...
redirect_from:
  - 2023/10/06/duckcon4
  - events/2023/10/06/duckcon4
---

<img src="{% link images/duckcon4-splashscreen.png %}"
...
However, the slides and recorded videos of the talks will be published a few weeks after the event, similarly to [DuckCon #3]({% link _events/2023-06-29-duckcon3.md %}).
