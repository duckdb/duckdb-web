...
With the Raspberry Pi 5, you can run DuckDB on large datasets with a reasonable budget: for just $300, you can [build a Raspberry Pi that runs TPC-H SF1,000]({% post_url 2025-01-17-raspberryi-pi-tpch %}).
