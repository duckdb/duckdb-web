...
Our setup included two server platforms and two DuckDB versions.
...
| DuckDB           | 1.5.5            | 2.0.0-dev        | 1.5.5            | 2.0.0-dev        |
...
The results show a 24–26% improvement for DuckDB v2.0.0-dev over DuckDB v1.5.5,
