...
doc_file = 'docs/current/configuration/overview.md'
...
text += (
    ...
    + "Configuration options come with different default [scopes]({% link docs/current/sql/statements/set.md %}#scopes): `GLOBAL` and `LOCAL`. "
